...
PROTOBUF_CONSTEXPR CSOCitadelLobby::CSOCitadelLobby(
  ...
  , /*decltype(_impl_.match_punishes_abandons_)*/false} {}
...
PROTOBUF_CONSTEXPR CMsgStartFindingMatchInfo::CMsgStartFindingMatchInfo(
  ...
  , /*decltype(_impl_.prefer_solo_only_)*/false
...
PROTOBUF_CONSTEXPR CSOCitadelParty_PrivateLobbySlot::CSOCitadelParty_PrivateLobbySlot(
    ::_pbi::ConstantInitialized): _impl_{
    /*decltype(_impl_._has_bits_)*/{}
  , /*decltype(_impl_._cached_size_)*/{}
...
struct CSOCitadelParty_PrivateLobbySlotDefaultTypeInternal {
  PROTOBUF_CONSTEXPR CSOCitadelParty_PrivateLobbySlotDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
  ~CSOCitadelParty_PrivateLobbySlotDefaultTypeInternal() {}
  union {
    CSOCitadelParty_PrivateLobbySlot _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 CSOCitadelParty_PrivateLobbySlotDefaultTypeInternal _CSOCitadelParty_PrivateLobbySlot_default_instance_;
PROTOBUF_CONSTEXPR CSOCitadelParty_ServerRegion::CSOCitadelParty_ServerRegion(
    ::_pbi::ConstantInitialized): _impl_{
    /*decltype(_impl_._has_bits_)*/{}
  , /*decltype(_impl_._cached_size_)*/{}
  , /*decltype(_impl_.region_id_)*/0u} {}
struct CSOCitadelParty_ServerRegionDefaultTypeInternal {
  PROTOBUF_CONSTEXPR CSOCitadelParty_ServerRegionDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
  ~CSOCitadelParty_ServerRegionDefaultTypeInternal() {}
  union {
    CSOCitadelParty_ServerRegion _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 CSOCitadelParty_ServerRegionDefaultTypeInternal _CSOCitadelParty_ServerRegion_default_instance_;
PROTOBUF_CONSTEXPR CSOCitadelParty_PrivateLobbySettings::CSOCitadelParty_PrivateLobbySettings(
    ::_pbi::ConstantInitialized): _impl_{
    /*decltype(_impl_._has_bits_)*/{}
  , /*decltype(_impl_._cached_size_)*/{}
  , /*decltype(_impl_.match_slots_)*/{}
  , /*decltype(_impl_.available_regions_)*/{}
  , /*decltype(_impl_.min_roster_size_)*/0u
  , /*decltype(_impl_.server_region_)*/0u
  , /*decltype(_impl_.randomize_lanes_)*/false
  , /*decltype(_impl_.is_publicly_visible_)*/false
...
struct CSOCitadelParty_PrivateLobbySettingsDefaultTypeInternal {
  PROTOBUF_CONSTEXPR CSOCitadelParty_PrivateLobbySettingsDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
  ~CSOCitadelParty_PrivateLobbySettingsDefaultTypeInternal() {}
  union {
    CSOCitadelParty_PrivateLobbySettings _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 CSOCitadelParty_PrivateLobbySettingsDefaultTypeInternal _CSOCitadelParty_PrivateLobbySettings_default_instance_;
...
PROTOBUF_CONSTEXPR CSOCitadelParty::CSOCitadelParty(
  ...
  , /*decltype(_impl_.server_search_key_)*/{&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}}
  , /*decltype(_impl_.private_lobby_settings_)*/nullptr
  ...
  , /*decltype(_impl_.desires_laning_together_)*/false
  , /*decltype(_impl_.mm_preference_)*/0} {}
...
PROTOBUF_CONSTEXPR CMsgMatchMetaDataContents_MatchInfo::CMsgMatchMetaDataContents_MatchInfo(
  ...
  , /*decltype(_impl_.average_badge_team0_)*/0u
  , /*decltype(_impl_.average_badge_team1_)*/0u} {}
...
PROTOBUF_CONSTEXPR CMsgGCAccountData::CMsgGCAccountData(
    ::_pbi::ConstantInitialized): _impl_{
    /*decltype(_impl_._has_bits_)*/{}
  , /*decltype(_impl_._cached_size_)*/{}
  , /*decltype(_impl_.account_id_)*/0u
  , /*decltype(_impl_.cheater_report_score_)*/0} {}
struct CMsgGCAccountDataDefaultTypeInternal {
  PROTOBUF_CONSTEXPR CMsgGCAccountDataDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
  ~CMsgGCAccountDataDefaultTypeInternal() {}
  union {
    CMsgGCAccountData _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 CMsgGCAccountDataDefaultTypeInternal _CMsgGCAccountData_default_instance_;
static ::_pb::Metadata file_level_metadata_citadel_5fgcmessages_5fcommon_2eproto[47];
static const ::_pb::EnumDescriptor* file_level_enum_descriptors_citadel_5fgcmessages_5fcommon_2eproto[21];
...
const uint32_t TableStruct_citadel_5fgcmessages_5fcommon_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::CSOCitadelLobby, _impl_.match_punishes_abandons_),
  1,
  2,
  3,
  4,
  ...
  PROTOBUF_FIELD_OFFSET(::CMsgStartFindingMatchInfo, _impl_.prefer_solo_only_),
  PROTOBUF_FIELD_OFFSET(::CMsgStartFindingMatchInfo, _impl_.mm_preference_),
  0,
  1,
  2,
  3,
  ...
  PROTOBUF_FIELD_OFFSET(::CSOCitadelParty_PrivateLobbySlot, _impl_._has_bits_),
  PROTOBUF_FIELD_OFFSET(::CSOCitadelParty_PrivateLobbySlot, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::CSOCitadelParty_PrivateLobbySlot, _impl_.slot_id_),
  PROTOBUF_FIELD_OFFSET(::CSOCitadelParty_PrivateLobbySlot, _impl_.player_account_id_),
  0,
  1,
  PROTOBUF_FIELD_OFFSET(::CSOCitadelParty_ServerRegion, _impl_._has_bits_),
  PROTOBUF_FIELD_OFFSET(::CSOCitadelParty_ServerRegion, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::CSOCitadelParty_ServerRegion, _impl_.region_id_),
  0,
  PROTOBUF_FIELD_OFFSET(::CSOCitadelParty_PrivateLobbySettings, _impl_._has_bits_),
  PROTOBUF_FIELD_OFFSET(::CSOCitadelParty_PrivateLobbySettings, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::CSOCitadelParty_PrivateLobbySettings, _impl_.min_roster_size_),
  PROTOBUF_FIELD_OFFSET(::CSOCitadelParty_PrivateLobbySettings, _impl_.match_slots_),
  PROTOBUF_FIELD_OFFSET(::CSOCitadelParty_PrivateLobbySettings, _impl_.randomize_lanes_),
  PROTOBUF_FIELD_OFFSET(::CSOCitadelParty_PrivateLobbySettings, _impl_.server_region_),
  PROTOBUF_FIELD_OFFSET(::CSOCitadelParty_PrivateLobbySettings, _impl_.is_publicly_visible_),
  PROTOBUF_FIELD_OFFSET(::CSOCitadelParty_PrivateLobbySettings, _impl_.cheats_enabled_),
  PROTOBUF_FIELD_OFFSET(::CSOCitadelParty_PrivateLobbySettings, _impl_.available_regions_),
  PROTOBUF_FIELD_OFFSET(::CSOCitadelParty_PrivateLobbySettings, _impl_.duplicate_heroes_enabled_),
  PROTOBUF_FIELD_OFFSET(::CSOCitadelParty_PrivateLobbySettings, _impl_.experimental_heroes_enabled_),
  0,
  ~0u,
  2,
  1,
  ...
  PROTOBUF_FIELD_OFFSET(::CSOCitadelParty, _impl_.is_private_lobby_),
  PROTOBUF_FIELD_OFFSET(::CSOCitadelParty, _impl_.private_lobby_settings_),
  PROTOBUF_FIELD_OFFSET(::CSOCitadelParty, _impl_.desires_laning_together_),
  PROTOBUF_FIELD_OFFSET(::CSOCitadelParty, _impl_.mm_preference_),
  3,
  ~0u,
  ~0u,
  0,
  ...
  PROTOBUF_FIELD_OFFSET(::CMsgMatchMetaDataContents_MatchInfo, _impl_.is_high_skill_range_parties_),
  PROTOBUF_FIELD_OFFSET(::CMsgMatchMetaDataContents_MatchInfo, _impl_.low_pri_pool_),
  PROTOBUF_FIELD_OFFSET(::CMsgMatchMetaDataContents_MatchInfo, _impl_.new_player_pool_),
  PROTOBUF_FIELD_OFFSET(::CMsgMatchMetaDataContents_MatchInfo, _impl_.average_badge_team0_),
  PROTOBUF_FIELD_OFFSET(::CMsgMatchMetaDataContents_MatchInfo, _impl_.average_badge_team1_),
  2,
  3,
  4,
  ~0u,
  ...
  0,
  ~0u,
  PROTOBUF_FIELD_OFFSET(::CMsgGCAccountData, _impl_._has_bits_),
  PROTOBUF_FIELD_OFFSET(::CMsgGCAccountData, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::CMsgGCAccountData, _impl_.account_id_),
  PROTOBUF_FIELD_OFFSET(::CMsgGCAccountData, _impl_.cheater_report_score_),
  0,
  1,
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 20, -1, sizeof(::CSOCitadelLobby)},
  { 34, 42, -1, sizeof(::CLobbyData_PostMatchSurvey_PlayerSurvey)},
  { 44, -1, -1, sizeof(::CLobbyData_PostMatchSurvey)},
  { 51, 59, -1, sizeof(::CMsgHeroSelectionMatchInfo_Hero)},
  { 61, -1, -1, sizeof(::CMsgHeroSelectionMatchInfo)},
  { 68, 82, -1, sizeof(::CMsgStartFindingMatchInfo)},
  { 90, 104, -1, sizeof(::CMsgAnyToGCReportAsserts_TrackedAssert)},
  { 112, 120, -1, sizeof(::CMsgAnyToGCReportAsserts)},
  { 122, 129, -1, sizeof(::CMsgAnyToGCReportAssertsResponse)},
  { 130, -1, -1, sizeof(::CMsgRegionPingTimesClient)},
  { 138, 146, -1, sizeof(::CSOCitadelParty_PrivateLobbySlot)},
  { 148, 155, -1, sizeof(::CSOCitadelParty_ServerRegion)},
  { 156, 171, -1, sizeof(::CSOCitadelParty_PrivateLobbySettings)},
  { 180, 198, -1, sizeof(::CSOCitadelParty_Member)},
  { 210, 219, -1, sizeof(::CSOCitadelParty_LeftMember)},
  { 222, 231, -1, sizeof(::CSOCitadelParty_Invite)},
  { 234, 258, -1, sizeof(::CSOCitadelParty)},
  { 276, 291, -1, sizeof(::CMsgMatchPlayerPathsData_Path)},
  { 300, 311, -1, sizeof(::CMsgMatchPlayerPathsData)},
  { 316, 324, -1, sizeof(::CMsgMatchPlayerDamageMatrix_DamageToPlayer)},
  { 326, 334, -1, sizeof(::CMsgMatchPlayerDamageMatrix_DamageSource)},
  { 336, 344, -1, sizeof(::CMsgMatchPlayerDamageMatrix_DamageDealer)},
  { 346, -1, -1, sizeof(::CMsgMatchPlayerDamageMatrix_SourceDetails)},
  { 354, 363, -1, sizeof(::CMsgMatchPlayerDamageMatrix)},
  { 366, 375, -1, sizeof(::CMsgMatchMetaDataContents_Position)},
  { 378, 389, -1, sizeof(::CMsgMatchMetaDataContents_Deaths)},
  { 394, 406, -1, sizeof(::CMsgMatchMetaDataContents_Items)},
  { 412, 421, -1, sizeof(::CMsgMatchMetaDataContents_Ping)},
  { 424, 435, -1, sizeof(::CMsgMatchMetaDataContents_GoldSource)},
  { 440, 448, -1, sizeof(::CMsgMatchMetaDataContents_CustomUserStatInfo)},
  { 450, 458, -1, sizeof(::CMsgMatchMetaDataContents_CustomUserStat)},
  { 460, 509, -1, sizeof(::CMsgMatchMetaDataContents_PlayerStats)},
  { 552, 560, -1, sizeof(::CMsgMatchMetaDataContents_AbilityStat)},
  { 562, 571, -1, sizeof(::CMsgMatchMetaDataContents_BookReward)},
  { 574, 602, -1, sizeof(::CMsgMatchMetaDataContents_Players)},
  { 624, 639, -1, sizeof(::CMsgMatchMetaDataContents_Objective)},
  { 648, 657, -1, sizeof(::CMsgMatchMetaDataContents_MidBoss)},
  { 660, 669, -1, sizeof(::CMsgMatchMetaDataContents_Pause)},
  { 672, 680, -1, sizeof(::CMsgMatchMetaDataContents_WatchedDeathReplay)},
  { 682, 711, -1, sizeof(::CMsgMatchMetaDataContents_MatchInfo)},
  { 734, 741, -1, sizeof(::CMsgMatchMetaDataContents)},
  { 742, 751, -1, sizeof(::CMsgMatchMetaData)},
  { 754, 763, -1, sizeof(::CMsgMapLine)},
  { 766, 778, -1, sizeof(::CMsgAccountHeroStats)},
  { 784, 793, -1, sizeof(::CMsgAccountBookStats)},
  { 796, 804, -1, sizeof(::CMsgAccountStats)},
  { 806, 814, -1, sizeof(::CMsgGCAccountData)},
};
...
static const ::_pb::Message* const file_default_instances[] = {
  ...
  &::_CSOCitadelParty_PrivateLobbySlot_default_instance_._instance,
  &::_CSOCitadelParty_ServerRegion_default_instance_._instance,
  &::_CSOCitadelParty_PrivateLobbySettings_default_instance_._instance,
  ...
  &::_CMsgGCAccountData_default_instance_._instance,
};
...
const char descriptor_table_protodef_citadel_5fgcmessages_5fcommon_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "messages.proto\032\026gcsdk_gcmessages.proto\"\374"
  ...
  "rsion\030\r \001(\r\022\027\n\017safe_to_abandon\030\016 \001(\010\022\037\n\027"
  "match_punishes_abandons\030\017 \001(\010\"\220\001\n\032CLobby"
  "Data_PostMatchSurvey\0229\n\007surveys\030\001 \003(\0132(."
  "CLobbyData_PostMatchSurvey.PlayerSurvey\032"
  "7\n\014PlayerSurvey\022\022\n\naccount_id\030\001 \001(\r\022\023\n\013q"
  "uestion_id\030\002 \001(\r\"\202\001\n\032CMsgHeroSelectionMa"
  "tchInfo\0229\n\017hero_selections\030\001 \003(\0132 .CMsgH"
  "eroSelectionMatchInfo.Hero\032)\n\004Hero\022\017\n\007he"
  "ro_id\030\001 \001(\r\022\020\n\010priority\030\002 \001(\r\"\326\003\n\031CMsgSt"
  "artFindingMatchInfo\022\031\n\021server_search_key"
  "\030\001 \001(\t\022\035\n\025server_command_string\030\002 \001(\t\022C\n"
  "\nmatch_mode\030\003 \001(\0162\022.ECitadelMatchMode:\033k"
  "_ECitadelMatchMode_Invalid\022@\n\tgame_mode\030"
  "\005 \001(\0162\021.ECitadelGameMode:\032k_ECitadelGame"
  "Mode_Invalid\022L\n\016bot_difficulty\030\007 \001(\0162\026.E"
  "CitadelBotDifficulty:\034k_ECitadelBotDiffi"
  "culty_None\022B\n\013region_mode\030\010 \001(\0162\023.ECitad"
  "elRegionMode:\030k_ECitadelRegionMode_ROW\022\030"
  "\n\020prefer_solo_only\030\t \001(\010\022L\n\rmm_preferenc"
  "e\030\n \001(\0162\025.ECitadelMMPreference:\036k_ECitad"
  "elMMPreference_Invalid\"\242\002\n\030CMsgAnyToGCRe"
  "portAsserts\022\017\n\007version\030\001 \001(\r\0228\n\007asserts\030"
  "\002 \003(\0132\'.CMsgAnyToGCReportAsserts.Tracked"
  ...
  "MsgAnyToGCReportAssertsResponse\022\017\n\007succe"
  "ss\030\001 \001(\010\"R\n\031CMsgRegionPingTimesClient\022\035\n"
  "\021data_center_codes\030\001 \003(\007B\002\020\001\022\026\n\nping_tim"
  "es\030\002 \003(\rB\002\020\001\"\246\020\n\017CSOCitadelParty\022\020\n\010part"
  "y_id\030\001 \001(\004\022(\n\007members\030\002 \003(\0132\027.CSOCitadel"
  "Party.Member\022(\n\007invites\030\003 \003(\0132\027.CSOCitad"
  "elParty.Invite\022\032\n\022dev_server_command\030\004 \001"
  "(\t\0221\n\014left_members\030\005 \003(\0132\033.CSOCitadelPar"
  "ty.LeftMember\022\021\n\tjoin_code\030\006 \001(\004\022L\n\016bot_"
  "difficulty\030\007 \001(\0162\026.ECitadelBotDifficulty"
  ":\034k_ECitadelBotDifficulty_None\022C\n\nmatch_"
  "mode\030\t \001(\0162\022.ECitadelMatchMode:\033k_ECitad"
  "elMatchMode_Invalid\022@\n\tgame_mode\030\n \001(\0162\021"
  ".ECitadelGameMode:\032k_ECitadelGameMode_In"
  "valid\022\037\n\027match_making_start_time\030\013 \001(\r\022\031"
  "\n\021server_search_key\030\014 \001(\t\022!\n\031is_high_ski"
  "ll_range_party\030\r \001(\010\0226\n\tchat_mode\030\016 \001(\0162"
  "\032.CSOCitadelParty.EChatMode:\007k_eNone\022B\n\013"
  "region_mode\030\017 \001(\0162\023.ECitadelRegionMode:\030"
  "k_ECitadelRegionMode_ROW\022\030\n\020is_private_l"
  "obby\030\020 \001(\010\022E\n\026private_lobby_settings\030\021 \001"
  "(\0132%.CSOCitadelParty.PrivateLobbySetting"
  "s\022\037\n\027desires_laning_together\030\022 \001(\010\022L\n\rmm"
  "_preference\030\023 \001(\0162\025.ECitadelMMPreference"
  ":\036k_ECitadelMMPreference_Invalid\032>\n\020Priv"
  "ateLobbySlot\022\017\n\007slot_id\030\001 \001(\r\022\031\n\021player_"
  "account_id\030\002 \001(\r\032!\n\014ServerRegion\022\021\n\tregi"
  "on_id\030\001 \001(\r\032\315\002\n\024PrivateLobbySettings\022\027\n\017"
  "min_roster_size\030\001 \001(\r\0226\n\013match_slots\030\002 \003"
  "(\0132!.CSOCitadelParty.PrivateLobbySlot\022\027\n"
  "\017randomize_lanes\030\003 \001(\010\022\025\n\rserver_region\030"
  "\004 \001(\r\022\033\n\023is_publicly_visible\030\006 \001(\010\022\026\n\016ch"
  "eats_enabled\030\007 \001(\010\0228\n\021available_regions\030"
  "\010 \003(\0132\035.CSOCitadelParty.ServerRegion\022 \n\030"
  "duplicate_heroes_enabled\030\t \001(\010\022#\n\033experi"
  "mental_heroes_enabled\030\n \001(\010\032\202\003\n\006Member\022\022"
  ...
  "\022\030\n\024k_eType_LethalDamage\020\004\"\312$\n\031CMsgMatch"
  ...
  "s\030\001 \001(\r\022\023\n\013player_slot\030\002 \001(\r\032\254\010\n\tMatchIn"
  ...
  "\0132\".CMsgMatchMetaDataContents.MidBoss\022#\n"
  "\033is_high_skill_range_parties\030\024 \001(\010\022\024\n\014lo"
  "w_pri_pool\030\025 \001(\010\022\027\n\017new_player_pool\030\026 \001("
  "\010\022\033\n\023average_badge_team0\030\027 \001(\r\022\033\n\023averag"
  "e_badge_team1\030\030 \001(\r\"=\n\rEMatchOutcome\022\026\n\022"
  "k_eOutcome_TeamWin\020\000\022\024\n\020k_eOutcome_Error"
  "\020\001\"\222\001\n\013EGoldSource\022\016\n\nk_ePlayers\020\001\022\021\n\rk_"
  "eLaneCreeps\020\002\022\017\n\013k_eNeutrals\020\003\022\r\n\tk_eBos"
  "ses\020\004\022\017\n\013k_eTreasure\020\005\022\016\n\nk_eAssists\020\006\022\r"
  "\n\tk_eDenies\020\007\022\020\n\014k_eTeamBonus\020\010\"M\n\021CMsgM"
  ...
  "countStats\022\022\n\naccount_id\030\001 \001(\r\022$\n\005stats\030"
  "\002 \003(\0132\025.CMsgAccountHeroStats\"E\n\021CMsgGCAc"
  "countData\022\022\n\naccount_id\030\001 \001(\r\022\034\n\024cheater"
  "_report_score\030\002 \001(\002*\212\001\n\rCMsgLaneColor\022\030\n"
  "\024k_ELaneColor_Invalid\020\000\022\027\n\023k_ELaneColor_"
  "Yellow\020\001\022\026\n\022k_ELaneColor_Green\020\003\022\025\n\021k_EL"
  "aneColor_Blue\020\004\022\027\n\023k_ELaneColor_Purple\020\006"
  "*d\n\030EGCCitadelCommonMessages\022\037\n\032k_EMsgAn"
  "yToGCReportAsserts\020\3306\022\'\n\"k_EMsgAnyToGCRe"
  "portAssertsResponse\020\3316*\245\002\n\021ECitadelMatch"
  "Mode\022\037\n\033k_ECitadelMatchMode_Invalid\020\000\022 \n"
  "\034k_ECitadelMatchMode_Unranked\020\001\022$\n k_ECi"
  "tadelMatchMode_PrivateLobby\020\002\022\037\n\033k_ECita"
  "delMatchMode_CoopBot\020\003\022\036\n\032k_ECitadelMatc"
  "hMode_Ranked\020\004\022\"\n\036k_ECitadelMatchMode_Se"
  "rverTest\020\005\022 \n\034k_ECitadelMatchMode_Tutori"
  "al\020\006\022 \n\034k_ECitadelMatchMode_HeroLabs\020\007*t"
  "\n\021ECitadelLobbyTeam\022\035\n\031k_ECitadelLobbyTe"
  "am_Team0\020\000\022\035\n\031k_ECitadelLobbyTeam_Team1\020"
  "\001\022!\n\035k_ECitadelLobbyTeam_Spectator\020\020*R\n\030"
  "ECitadelAccountStatMedal\022\013\n\007k_eNone\020\000\022\r\n"
  "\tk_eBronze\020\001\022\r\n\tk_eSilver\020\002\022\013\n\007k_eGold\020\003"
  "*\201\001\n\024ECitadelMMPreference\022\"\n\036k_ECitadelM"
  "MPreference_Invalid\020\000\022!\n\035k_ECitadelMMPre"
  "ference_Casual\020\001\022\"\n\036k_ECitadelMMPreferen"
  "ce_Serious\020\002*\332\013\n\021ECitadelObjective\022\"\n\036k_"
  "eCitadelObjective_Team0_Core\020\000\022)\n%k_eCit"
  "adelObjective_Team0_Tier1_Lane1\020\001\022)\n%k_e"
  "CitadelObjective_Team0_Tier1_Lane2\020\002\022)\n%"
  "k_eCitadelObjective_Team0_Tier1_Lane3\020\003\022"
  ")\n%k_eCitadelObjective_Team0_Tier1_Lane4"
  "\020\004\022)\n%k_eCitadelObjective_Team0_Tier2_La"
  "ne1\020\005\022)\n%k_eCitadelObjective_Team0_Tier2"
  "_Lane2\020\006\022)\n%k_eCitadelObjective_Team0_Ti"
  "er2_Lane3\020\007\022)\n%k_eCitadelObjective_Team0"
  "_Tier2_Lane4\020\010\022#\n\037k_eCitadelObjective_Te"
  "am0_Titan\020\t\0224\n0k_eCitadelObjective_Team0"
  "_TitanShieldGenerator_1\020\n\0224\n0k_eCitadelO"
  "bjective_Team0_TitanShieldGenerator_2\020\013\022"
  "/\n+k_eCitadelObjective_Team0_BarrackBoss"
  "_Lane1\020\014\022/\n+k_eCitadelObjective_Team0_Ba"
  "rrackBoss_Lane2\020\r\022/\n+k_eCitadelObjective"
  "_Team0_BarrackBoss_Lane3\020\016\022/\n+k_eCitadel"
  "Objective_Team0_BarrackBoss_Lane4\020\017\022\"\n\036k"
  "_eCitadelObjective_Team1_Core\020\020\022)\n%k_eCi"
  "tadelObjective_Team1_Tier1_Lane1\020\021\022)\n%k_"
  "eCitadelObjective_Team1_Tier1_Lane2\020\022\022)\n"
  "%k_eCitadelObjective_Team1_Tier1_Lane3\020\023"
  "\022)\n%k_eCitadelObjective_Team1_Tier1_Lane"
  "4\020\024\022)\n%k_eCitadelObjective_Team1_Tier2_L"
  "ane1\020\025\022)\n%k_eCitadelObjective_Team1_Tier"
  "2_Lane2\020\026\022)\n%k_eCitadelObjective_Team1_T"
  "ier2_Lane3\020\027\022)\n%k_eCitadelObjective_Team"
  "1_Tier2_Lane4\020\030\022#\n\037k_eCitadelObjective_T"
  "eam1_Titan\020\031\0224\n0k_eCitadelObjective_Team"
  "1_TitanShieldGenerator_1\020\032\0224\n0k_eCitadel"
  "Objective_Team1_TitanShieldGenerator_2\020\033"
  "\022/\n+k_eCitadelObjective_Team1_BarrackBos"
  "s_Lane1\020\034\022/\n+k_eCitadelObjective_Team1_B"
  "arrackBoss_Lane2\020\035\022/\n+k_eCitadelObjectiv"
  "e_Team1_BarrackBoss_Lane3\020\036\022/\n+k_eCitade"
  "lObjective_Team1_BarrackBoss_Lane4\020\037\022#\n\037"
  "k_eCitadelObjective_Neutral_Mid\020 *\310\005\n\025EC"
  "itadelTeamObjective\022 \n\034k_eCitadelTeamObj"
  "ective_Core\020\000\022\'\n#k_eCitadelTeamObjective"
  "_Tier1_Lane1\020\001\022\'\n#k_eCitadelTeamObjectiv"
  "e_Tier1_Lane2\020\002\022\'\n#k_eCitadelTeamObjecti"
  "ve_Tier1_Lane3\020\003\022\'\n#k_eCitadelTeamObject"
  "ive_Tier1_Lane4\020\004\022\'\n#k_eCitadelTeamObjec"
  "tive_Tier2_Lane1\020\005\022\'\n#k_eCitadelTeamObje"
  "ctive_Tier2_Lane2\020\006\022\'\n#k_eCitadelTeamObj"
  "ective_Tier2_Lane3\020\007\022\'\n#k_eCitadelTeamOb"
  "jective_Tier2_Lane4\020\010\022!\n\035k_eCitadelTeamO"
  "bjective_Titan\020\t\0222\n.k_eCitadelTeamObject"
  "ive_TitanShieldGenerator_1\020\n\0222\n.k_eCitad"
  "elTeamObjective_TitanShieldGenerator_2\020\013"
  "\022-\n)k_eCitadelTeamObjective_BarrackBoss_"
  "Lane1\020\014\022-\n)k_eCitadelTeamObjective_Barra"
  "ckBoss_Lane2\020\r\022-\n)k_eCitadelTeamObjectiv"
  "e_BarrackBoss_Lane3\020\016\022-\n)k_eCitadelTeamO"
  "bjective_BarrackBoss_Lane4\020\017*\354\001\n\025ECitade"
  "lBotDifficulty\022 \n\034k_ECitadelBotDifficult"
  "y_None\020\000\022 \n\034k_ECitadelBotDifficulty_Easy"
  "\020\001\022\"\n\036k_ECitadelBotDifficulty_Medium\020\002\022 "
  "\n\034k_ECitadelBotDifficulty_Hard\020\003\022%\n!k_EC"
  "itadelBotDifficulty_Nightmare\020\004\022\"\n\036k_ECi"
  "tadelBotDifficulty_Guided\020\005*\332\001\n\022ECitadel"
  "RegionMode\022\034\n\030k_ECitadelRegionMode_ROW\020\000"
  "\022\037\n\033k_ECitadelRegionMode_Europe\020\001\022\037\n\033k_E"
  "CitadelRegionMode_SEAsia\020\002\022!\n\035k_ECitadel"
  "RegionMode_SAmerica\020\003\022\037\n\033k_ECitadelRegio"
  "nMode_Russia\020\004\022 \n\034k_ECitadelRegionMode_O"
  "ceania\020\005*\214\002\n\031ECitadelLeaderboardRegion\022$"
  "\n k_ECitadelLeaderboardRegion_None\020\000\022&\n\""
  "k_ECitadelLeaderboardRegion_Europe\020\001\022$\n "
  "k_ECitadelLeaderboardRegion_Asia\020\002\022(\n$k_"
  "ECitadelLeaderboardRegion_NAmerica\020\003\022(\n$"
  "k_ECitadelLeaderboardRegion_SAmerica\020\004\022\'"
  "\n#k_ECitadelLeaderboardRegion_Oceania\020\005*"
  "\221\001\n\020ECitadelGameMode\022\036\n\032k_ECitadelGameMo"
  "de_Invalid\020\000\022\035\n\031k_ECitadelGameMode_Norma"
  "l\020\001\022\036\n\032k_ECitadelGameMode_1v1Test\020\002\022\036\n\032k"
  "_ECitadelGameMode_Sandbox\020\003*\274\001\n\021ELobbySe"
  "rverState\022\036\n\032k_eLobbyServerState_Assign\020"
  "\000\022\036\n\032k_eLobbyServerState_InGame\020\001\022!\n\035k_e"
  "LobbyServerState_PostMatch\020\002\022!\n\035k_eLobby"
  "ServerState_SignedOut\020\003\022!\n\035k_eLobbyServe"
  "rState_Abandoned\020\004*\251\001\n\016EBannedFeature\022\034\n"
  "\030k_eBannedFeature_Invalid\020\000\022+\n\'k_eBanned"
  "Feature_LowPriorityMatchmaking\020\001\022$\n k_eB"
  "annedFeature_CommsRestricted\020\002\022&\n\"k_eBan"
  "nedFeature_ReportingDisabled\020\003*\326\001\n\021EFeat"
  "ureBanReason\022\037\n\033k_eFeatureBanReason_Inva"
  "lid\020\000\022\"\n\036k_eFeatureBanReason_DevCommand\020"
  "\001\022%\n!k_eFeatureBanReason_PlayerReports\020\002"
  "\022%\n!k_eFeatureBanReason_MatchAbandons\020\003\022"
  ".\n*k_eFeatureBanReason_ExcessivePlayerRe"
  "ports\020\004"
  ;
...
const ::_pbi::DescriptorTable descriptor_table_citadel_5fgcmessages_5fcommon_2eproto = {
    false, false, 14647, descriptor_table_protodef_citadel_5fgcmessages_5fcommon_2eproto,
    "citadel_gcmessages_common.proto",
    &descriptor_table_citadel_5fgcmessages_5fcommon_2eproto_once, descriptor_table_citadel_5fgcmessages_5fcommon_2eproto_deps, 2, 47,
...
constexpr CMsgMatchMetaDataContents_EGoldSource CMsgMatchMetaDataContents::k_eTeamBonus;
...
const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* ECitadelGameMode_descriptor() {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_citadel_5fgcmessages_5fcommon_2eproto);
  return file_level_enum_descriptors_citadel_5fgcmessages_5fcommon_2eproto[17];
}
...
const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* ELobbyServerState_descriptor() {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_citadel_5fgcmessages_5fcommon_2eproto);
  return file_level_enum_descriptors_citadel_5fgcmessages_5fcommon_2eproto[18];
}
...
const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* EBannedFeature_descriptor() {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_citadel_5fgcmessages_5fcommon_2eproto);
  return file_level_enum_descriptors_citadel_5fgcmessages_5fcommon_2eproto[19];
}
...
const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* EFeatureBanReason_descriptor() {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_citadel_5fgcmessages_5fcommon_2eproto);
  return file_level_enum_descriptors_citadel_5fgcmessages_5fcommon_2eproto[20];
}
...
class CSOCitadelLobby::_Internal {
 public:
  ...
  static void set_has_match_punishes_abandons(HasBits* has_bits) {
    (*has_bits)[0] |= 4096u;
  }
};
...
CSOCitadelLobby::CSOCitadelLobby(const CSOCitadelLobby& from)
  ...
  new (&_impl_) Impl_{
    ...
    , decltype(_impl_.match_punishes_abandons_){}};
  ...
  ::memcpy(&_impl_.lobby_id_, &from._impl_.lobby_id_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.match_punishes_abandons_) -
    reinterpret_cast<char*>(&_impl_.lobby_id_)) + sizeof(_impl_.match_punishes_abandons_));
...
// @@protoc_insertion_point(message_clear_start:CSOCitadelLobby)
  ...
  if (cached_has_bits & 0x00001f00u) {
    ::memset(&_impl_.udp_connect_ip_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&_impl_.match_punishes_abandons_) -
        reinterpret_cast<char*>(&_impl_.udp_connect_ip_)) + sizeof(_impl_.match_punishes_abandons_));
  }
    ...
    switch (tag >> 3) {
      ...
      case 15:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 120)) {
          _Internal::set_has_match_punishes_abandons(&has_bits);
          _impl_.match_punishes_abandons_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* CSOCitadelLobby::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00001000u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteBoolToArray(15, this->_internal_match_punishes_abandons(), target);
  }
...
void CSOCitadelLobby::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (cached_has_bits & 0x00001f00u) {
    ...
    if (cached_has_bits & 0x00001000u) {
      _this->_impl_.match_punishes_abandons_ = from._impl_.match_punishes_abandons_;
    }
    _this->_impl_._has_bits_[0] |= cached_has_bits;
  }
...
void CSOCitadelLobby::InternalSwap(CSOCitadelLobby* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(CSOCitadelLobby, _impl_.match_punishes_abandons_)
      + sizeof(CSOCitadelLobby::_impl_.match_punishes_abandons_)
      - PROTOBUF_FIELD_OFFSET(CSOCitadelLobby, _impl_.lobby_id_)>(
...
class CMsgStartFindingMatchInfo::_Internal {
 public:
  ...
  static void set_has_prefer_solo_only(HasBits* has_bits) {
    (*has_bits)[0] |= 64u;
  }
...
CMsgStartFindingMatchInfo::CMsgStartFindingMatchInfo(const CMsgStartFindingMatchInfo& from)
  ...
  new (&_impl_) Impl_{
    ...
    , decltype(_impl_.prefer_solo_only_){}
  ...
  ::memcpy(&_impl_.match_mode_, &from._impl_.match_mode_,
    ...
    reinterpret_cast<char*>(&_impl_.match_mode_)) + sizeof(_impl_.mm_preference_));
...
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  ...
  while (!ctx->Done(&ptr)) {
    ...
    switch (tag >> 3) {
      ...
      case 9:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 72)) {
          _Internal::set_has_prefer_solo_only(&has_bits);
          _impl_.prefer_solo_only_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* CMsgStartFindingMatchInfo::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000040u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteBoolToArray(9, this->_internal_prefer_solo_only(), target);
  }
  ...
  if (cached_has_bits & 0x00000080u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteEnumToArray(
      10, this->_internal_mm_preference(), target);
  }
...
void CMsgStartFindingMatchInfo::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (cached_has_bits & 0x000000ffu) {
    ...
    if (cached_has_bits & 0x00000040u) {
      _this->_impl_.prefer_solo_only_ = from._impl_.prefer_solo_only_;
    }
    if (cached_has_bits & 0x00000080u) {
...
void CMsgStartFindingMatchInfo::InternalSwap(CMsgStartFindingMatchInfo* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(CMsgStartFindingMatchInfo, _impl_.mm_preference_)
      + sizeof(CMsgStartFindingMatchInfo::_impl_.mm_preference_)
      - PROTOBUF_FIELD_OFFSET(CMsgStartFindingMatchInfo, _impl_.match_mode_)>(
...
class CSOCitadelParty_PrivateLobbySlot::_Internal {
 public:
  using HasBits = decltype(std::declval<CSOCitadelParty_PrivateLobbySlot>()._impl_._has_bits_);
...
CSOCitadelParty_PrivateLobbySlot::CSOCitadelParty_PrivateLobbySlot(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:CSOCitadelParty.PrivateLobbySlot)
}
CSOCitadelParty_PrivateLobbySlot::CSOCitadelParty_PrivateLobbySlot(const CSOCitadelParty_PrivateLobbySlot& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  CSOCitadelParty_PrivateLobbySlot* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){from._impl_._has_bits_}
    , /*decltype(_impl_._cached_size_)*/{}
  ...
  ::memcpy(&_impl_.slot_id_, &from._impl_.slot_id_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.player_account_id_) -
    reinterpret_cast<char*>(&_impl_.slot_id_)) + sizeof(_impl_.player_account_id_));
  // @@protoc_insertion_point(copy_constructor:CSOCitadelParty.PrivateLobbySlot)
}

inline void CSOCitadelParty_PrivateLobbySlot::SharedCtor(
    ::_pb::Arena* arena, bool is_message_owned) {
  (void)arena;
  (void)is_message_owned;
  new (&_impl_) Impl_{
...
CSOCitadelParty_PrivateLobbySlot::~CSOCitadelParty_PrivateLobbySlot() {
  // @@protoc_insertion_point(destructor:CSOCitadelParty.PrivateLobbySlot)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
inline void CSOCitadelParty_PrivateLobbySlot::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
}

void CSOCitadelParty_PrivateLobbySlot::SetCachedSize(int size) const {
  _impl_._cached_size_.Set(size);
}

void CSOCitadelParty_PrivateLobbySlot::Clear() {
// @@protoc_insertion_point(message_clear_start:CSOCitadelParty.PrivateLobbySlot)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* CSOCitadelParty_PrivateLobbySlot::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  _Internal::HasBits has_bits{};
  while (!ctx->Done(&ptr)) {
    uint32_t tag;
...
uint8_t* CSOCitadelParty_PrivateLobbySlot::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:CSOCitadelParty.PrivateLobbySlot)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:CSOCitadelParty.PrivateLobbySlot)
  return target;
}

size_t CSOCitadelParty_PrivateLobbySlot::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:CSOCitadelParty.PrivateLobbySlot)
  size_t total_size = 0;
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData CSOCitadelParty_PrivateLobbySlot::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSourceCheck,
    CSOCitadelParty_PrivateLobbySlot::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*CSOCitadelParty_PrivateLobbySlot::GetClassData() const { return &_class_data_; }


void CSOCitadelParty_PrivateLobbySlot::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<CSOCitadelParty_PrivateLobbySlot*>(&to_msg);
  auto& from = static_cast<const CSOCitadelParty_PrivateLobbySlot&>(from_msg);
  // @@protoc_insertion_point(class_specific_merge_from_start:CSOCitadelParty.PrivateLobbySlot)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
void CSOCitadelParty_PrivateLobbySlot::CopyFrom(const CSOCitadelParty_PrivateLobbySlot& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:CSOCitadelParty.PrivateLobbySlot)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool CSOCitadelParty_PrivateLobbySlot::IsInitialized() const {
  return true;
}

void CSOCitadelParty_PrivateLobbySlot::InternalSwap(CSOCitadelParty_PrivateLobbySlot* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  swap(_impl_._has_bits_[0], other->_impl_._has_bits_[0]);
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(CSOCitadelParty_PrivateLobbySlot, _impl_.player_account_id_)
      + sizeof(CSOCitadelParty_PrivateLobbySlot::_impl_.player_account_id_)
      - PROTOBUF_FIELD_OFFSET(CSOCitadelParty_PrivateLobbySlot, _impl_.slot_id_)>(
          reinterpret_cast<char*>(&_impl_.slot_id_),
          reinterpret_cast<char*>(&other->_impl_.slot_id_));
}

::PROTOBUF_NAMESPACE_ID::Metadata CSOCitadelParty_PrivateLobbySlot::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_citadel_5fgcmessages_5fcommon_2eproto_getter, &descriptor_table_citadel_5fgcmessages_5fcommon_2eproto_once,
...
class CSOCitadelParty_ServerRegion::_Internal {
 public:
  using HasBits = decltype(std::declval<CSOCitadelParty_ServerRegion>()._impl_._has_bits_);
  static void set_has_region_id(HasBits* has_bits) {
    (*has_bits)[0] |= 1u;
  }
};

CSOCitadelParty_ServerRegion::CSOCitadelParty_ServerRegion(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:CSOCitadelParty.ServerRegion)
}
CSOCitadelParty_ServerRegion::CSOCitadelParty_ServerRegion(const CSOCitadelParty_ServerRegion& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  CSOCitadelParty_ServerRegion* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){from._impl_._has_bits_}
    , /*decltype(_impl_._cached_size_)*/{}
  ...
  // @@protoc_insertion_point(copy_constructor:CSOCitadelParty.ServerRegion)
}

inline void CSOCitadelParty_ServerRegion::SharedCtor(
    ::_pb::Arena* arena, bool is_message_owned) {
  (void)arena;
  (void)is_message_owned;
  new (&_impl_) Impl_{
...
CSOCitadelParty_ServerRegion::~CSOCitadelParty_ServerRegion() {
  // @@protoc_insertion_point(destructor:CSOCitadelParty.ServerRegion)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
inline void CSOCitadelParty_ServerRegion::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
}

void CSOCitadelParty_ServerRegion::SetCachedSize(int size) const {
  _impl_._cached_size_.Set(size);
}

void CSOCitadelParty_ServerRegion::Clear() {
// @@protoc_insertion_point(message_clear_start:CSOCitadelParty.ServerRegion)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* CSOCitadelParty_ServerRegion::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  _Internal::HasBits has_bits{};
  while (!ctx->Done(&ptr)) {
    uint32_t tag;
...
uint8_t* CSOCitadelParty_ServerRegion::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:CSOCitadelParty.ServerRegion)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (cached_has_bits & 0x00000001u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt32ToArray(1, this->_internal_region_id(), target);
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:CSOCitadelParty.ServerRegion)
  return target;
}

size_t CSOCitadelParty_ServerRegion::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:CSOCitadelParty.ServerRegion)
  size_t total_size = 0;
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData CSOCitadelParty_ServerRegion::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSourceCheck,
    CSOCitadelParty_ServerRegion::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*CSOCitadelParty_ServerRegion::GetClassData() const { return &_class_data_; }


void CSOCitadelParty_ServerRegion::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<CSOCitadelParty_ServerRegion*>(&to_msg);
  auto& from = static_cast<const CSOCitadelParty_ServerRegion&>(from_msg);
  // @@protoc_insertion_point(class_specific_merge_from_start:CSOCitadelParty.ServerRegion)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
void CSOCitadelParty_ServerRegion::CopyFrom(const CSOCitadelParty_ServerRegion& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:CSOCitadelParty.ServerRegion)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool CSOCitadelParty_ServerRegion::IsInitialized() const {
  return true;
}

void CSOCitadelParty_ServerRegion::InternalSwap(CSOCitadelParty_ServerRegion* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  swap(_impl_._has_bits_[0], other->_impl_._has_bits_[0]);
...
::PROTOBUF_NAMESPACE_ID::Metadata CSOCitadelParty_ServerRegion::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_citadel_5fgcmessages_5fcommon_2eproto_getter, &descriptor_table_citadel_5fgcmessages_5fcommon_2eproto_once,
...
class CSOCitadelParty_PrivateLobbySettings::_Internal {
 public:
  using HasBits = decltype(std::declval<CSOCitadelParty_PrivateLobbySettings>()._impl_._has_bits_);
  static void set_has_min_roster_size(HasBits* has_bits) {
    (*has_bits)[0] |= 1u;
  }
  static void set_has_randomize_lanes(HasBits* has_bits) {
    (*has_bits)[0] |= 4u;
  }
  static void set_has_server_region(HasBits* has_bits) {
    (*has_bits)[0] |= 2u;
  }
  static void set_has_is_publicly_visible(HasBits* has_bits) {
    (*has_bits)[0] |= 8u;
  }
...
CSOCitadelParty_PrivateLobbySettings::CSOCitadelParty_PrivateLobbySettings(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:CSOCitadelParty.PrivateLobbySettings)
}
CSOCitadelParty_PrivateLobbySettings::CSOCitadelParty_PrivateLobbySettings(const CSOCitadelParty_PrivateLobbySettings& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  CSOCitadelParty_PrivateLobbySettings* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){from._impl_._has_bits_}
    , /*decltype(_impl_._cached_size_)*/{}
    , decltype(_impl_.match_slots_){from._impl_.match_slots_}
    , decltype(_impl_.available_regions_){from._impl_.available_regions_}
    , decltype(_impl_.min_roster_size_){}
    , decltype(_impl_.server_region_){}
    , decltype(_impl_.randomize_lanes_){}
    , decltype(_impl_.is_publicly_visible_){}
    , decltype(_impl_.cheats_enabled_){}
    , decltype(_impl_.duplicate_heroes_enabled_){}
    , decltype(_impl_.experimental_heroes_enabled_){}};

  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::memcpy(&_impl_.min_roster_size_, &from._impl_.min_roster_size_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.experimental_heroes_enabled_) -
    reinterpret_cast<char*>(&_impl_.min_roster_size_)) + sizeof(_impl_.experimental_heroes_enabled_));
  // @@protoc_insertion_point(copy_constructor:CSOCitadelParty.PrivateLobbySettings)
}

inline void CSOCitadelParty_PrivateLobbySettings::SharedCtor(
    ::_pb::Arena* arena, bool is_message_owned) {
  (void)arena;
  (void)is_message_owned;
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){}
    , /*decltype(_impl_._cached_size_)*/{}
    , decltype(_impl_.match_slots_){arena}
    , decltype(_impl_.available_regions_){arena}
    , decltype(_impl_.min_roster_size_){0u}
    , decltype(_impl_.server_region_){0u}
    , decltype(_impl_.randomize_lanes_){false}
    , decltype(_impl_.is_publicly_visible_){false}
...
CSOCitadelParty_PrivateLobbySettings::~CSOCitadelParty_PrivateLobbySettings() {
  // @@protoc_insertion_point(destructor:CSOCitadelParty.PrivateLobbySettings)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
inline void CSOCitadelParty_PrivateLobbySettings::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
  _impl_.match_slots_.~RepeatedPtrField();
  _impl_.available_regions_.~RepeatedPtrField();
}

void CSOCitadelParty_PrivateLobbySettings::SetCachedSize(int size) const {
  _impl_._cached_size_.Set(size);
}

void CSOCitadelParty_PrivateLobbySettings::Clear() {
// @@protoc_insertion_point(message_clear_start:CSOCitadelParty.PrivateLobbySettings)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
  ...
  if (cached_has_bits & 0x0000007fu) {
    ::memset(&_impl_.min_roster_size_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&_impl_.experimental_heroes_enabled_) -
        reinterpret_cast<char*>(&_impl_.min_roster_size_)) + sizeof(_impl_.experimental_heroes_enabled_));
  }
  _impl_._has_bits_.Clear();
  _internal_metadata_.Clear<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
...
const char* CSOCitadelParty_PrivateLobbySettings::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  _Internal::HasBits has_bits{};
  while (!ctx->Done(&ptr)) {
    uint32_t tag;
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 8)) {
          _Internal::set_has_min_roster_size(&has_bits);
          _impl_.min_roster_size_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ...
          do {
            ptr += 1;
            ptr = ctx->ParseMessage(_internal_add_match_slots(), ptr);
            CHK_(ptr);
            if (!ctx->DataAvailable(ptr)) break;
          } while (::PROTOBUF_NAMESPACE_ID::internal::ExpectTag<18>(ptr));
        } else
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 24)) {
          _Internal::set_has_randomize_lanes(&has_bits);
          _impl_.randomize_lanes_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 6:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 48)) {
          _Internal::set_has_is_publicly_visible(&has_bits);
          _impl_.is_publicly_visible_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 8:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 66)) {
          ...
          do {
            ptr += 1;
            ptr = ctx->ParseMessage(_internal_add_available_regions(), ptr);
            CHK_(ptr);
            if (!ctx->DataAvailable(ptr)) break;
...
uint8_t* CSOCitadelParty_PrivateLobbySettings::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:CSOCitadelParty.PrivateLobbySettings)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (cached_has_bits & 0x00000001u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt32ToArray(1, this->_internal_min_roster_size(), target);
  }

  // repeated .CSOCitadelParty.PrivateLobbySlot match_slots = 2;
  for (unsigned i = 0,
      n = static_cast<unsigned>(this->_internal_match_slots_size()); i < n; i++) {
    const auto& repfield = this->_internal_match_slots(i);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
        InternalWriteMessage(2, repfield, repfield.GetCachedSize(), target, stream);
  }
  ...
  if (cached_has_bits & 0x00000004u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteBoolToArray(3, this->_internal_randomize_lanes(), target);
  }
  ...
  if (cached_has_bits & 0x00000008u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteBoolToArray(6, this->_internal_is_publicly_visible(), target);
  }

  // optional bool cheats_enabled = 7;
  if (cached_has_bits & 0x00000010u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteBoolToArray(7, this->_internal_cheats_enabled(), target);
  }

  // repeated .CSOCitadelParty.ServerRegion available_regions = 8;
  for (unsigned i = 0,
      n = static_cast<unsigned>(this->_internal_available_regions_size()); i < n; i++) {
    const auto& repfield = this->_internal_available_regions(i);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
  ...
  if (cached_has_bits & 0x00000020u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteBoolToArray(9, this->_internal_duplicate_heroes_enabled(), target);
  }

  // optional bool experimental_heroes_enabled = 10;
  if (cached_has_bits & 0x00000040u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteBoolToArray(10, this->_internal_experimental_heroes_enabled(), target);
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:CSOCitadelParty.PrivateLobbySettings)
  return target;
}

size_t CSOCitadelParty_PrivateLobbySettings::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:CSOCitadelParty.PrivateLobbySettings)
  size_t total_size = 0;
  ...
  // repeated .CSOCitadelParty.PrivateLobbySlot match_slots = 2;
  total_size += 1UL * this->_internal_match_slots_size();
  for (const auto& msg : this->_impl_.match_slots_) {
    total_size +=
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::MessageSize(msg);
  }

  // repeated .CSOCitadelParty.ServerRegion available_regions = 8;
  total_size += 1UL * this->_internal_available_regions_size();
  for (const auto& msg : this->_impl_.available_regions_) {
    total_size +=
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::MessageSize(msg);
  }
  ...
  if (cached_has_bits & 0x0000007fu) {
    // optional uint32 min_roster_size = 1;
    if (cached_has_bits & 0x00000001u) {
      total_size += ::_pbi::WireFormatLite::UInt32SizePlusOne(this->_internal_min_roster_size());
    }
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData CSOCitadelParty_PrivateLobbySettings::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSourceCheck,
    CSOCitadelParty_PrivateLobbySettings::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*CSOCitadelParty_PrivateLobbySettings::GetClassData() const { return &_class_data_; }


void CSOCitadelParty_PrivateLobbySettings::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<CSOCitadelParty_PrivateLobbySettings*>(&to_msg);
  auto& from = static_cast<const CSOCitadelParty_PrivateLobbySettings&>(from_msg);
  // @@protoc_insertion_point(class_specific_merge_from_start:CSOCitadelParty.PrivateLobbySettings)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;

  _this->_impl_.match_slots_.MergeFrom(from._impl_.match_slots_);
  _this->_impl_.available_regions_.MergeFrom(from._impl_.available_regions_);
  cached_has_bits = from._impl_._has_bits_[0];
  if (cached_has_bits & 0x0000007fu) {
    if (cached_has_bits & 0x00000001u) {
      _this->_impl_.min_roster_size_ = from._impl_.min_roster_size_;
    }
    if (cached_has_bits & 0x00000002u) {
      _this->_impl_.server_region_ = from._impl_.server_region_;
    }
    if (cached_has_bits & 0x00000004u) {
      _this->_impl_.randomize_lanes_ = from._impl_.randomize_lanes_;
    }
    if (cached_has_bits & 0x00000008u) {
      _this->_impl_.is_publicly_visible_ = from._impl_.is_publicly_visible_;
    }
    if (cached_has_bits & 0x00000010u) {
...
void CSOCitadelParty_PrivateLobbySettings::CopyFrom(const CSOCitadelParty_PrivateLobbySettings& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:CSOCitadelParty.PrivateLobbySettings)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool CSOCitadelParty_PrivateLobbySettings::IsInitialized() const {
  return true;
}

void CSOCitadelParty_PrivateLobbySettings::InternalSwap(CSOCitadelParty_PrivateLobbySettings* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  swap(_impl_._has_bits_[0], other->_impl_._has_bits_[0]);
  _impl_.match_slots_.InternalSwap(&other->_impl_.match_slots_);
  _impl_.available_regions_.InternalSwap(&other->_impl_.available_regions_);
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(CSOCitadelParty_PrivateLobbySettings, _impl_.experimental_heroes_enabled_)
      + sizeof(CSOCitadelParty_PrivateLobbySettings::_impl_.experimental_heroes_enabled_)
      - PROTOBUF_FIELD_OFFSET(CSOCitadelParty_PrivateLobbySettings, _impl_.min_roster_size_)>(
          reinterpret_cast<char*>(&_impl_.min_roster_size_),
          reinterpret_cast<char*>(&other->_impl_.min_roster_size_));
}

::PROTOBUF_NAMESPACE_ID::Metadata CSOCitadelParty_PrivateLobbySettings::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_citadel_5fgcmessages_5fcommon_2eproto_getter, &descriptor_table_citadel_5fgcmessages_5fcommon_2eproto_once,
...
class CSOCitadelParty::_Internal {
 public:
  ...
  static const ::CSOCitadelParty_PrivateLobbySettings& private_lobby_settings(const CSOCitadelParty* msg);
  static void set_has_private_lobby_settings(HasBits* has_bits) {
    (*has_bits)[0] |= 4u;
  }
  static void set_has_desires_laning_together(HasBits* has_bits) {
    (*has_bits)[0] |= 8192u;
  }
  static void set_has_mm_preference(HasBits* has_bits) {
    (*has_bits)[0] |= 16384u;
...
const ::CSOCitadelParty_PrivateLobbySettings&
CSOCitadelParty::_Internal::private_lobby_settings(const CSOCitadelParty* msg) {
  return *msg->_impl_.private_lobby_settings_;
}
...
CSOCitadelParty::CSOCitadelParty(const CSOCitadelParty& from)
  ...
  new (&_impl_) Impl_{
    ...
    , decltype(_impl_.desires_laning_together_){}
    , decltype(_impl_.mm_preference_){}};
  ...
  if (from._internal_has_private_lobby_settings()) {
    _this->_impl_.private_lobby_settings_ = new ::CSOCitadelParty_PrivateLobbySettings(*from._impl_.private_lobby_settings_);
  }
  ::memcpy(&_impl_.party_id_, &from._impl_.party_id_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.mm_preference_) -
    reinterpret_cast<char*>(&_impl_.party_id_)) + sizeof(_impl_.mm_preference_));
...
inline void CSOCitadelParty::SharedDtor() {
  ...
  _impl_.server_search_key_.Destroy();
  if (this != internal_default_instance()) delete _impl_.private_lobby_settings_;
}
...
// @@protoc_insertion_point(message_clear_start:CSOCitadelParty)
  ...
  if (cached_has_bits & 0x00000007u) {
    ...
    if (cached_has_bits & 0x00000004u) {
      GOOGLE_DCHECK(_impl_.private_lobby_settings_ != nullptr);
      _impl_.private_lobby_settings_->Clear();
    }
  }
  if (cached_has_bits & 0x000000f8u) {
    ::memset(&_impl_.party_id_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&_impl_.game_mode_) -
        reinterpret_cast<char*>(&_impl_.party_id_)) + sizeof(_impl_.game_mode_));
  }
  if (cached_has_bits & 0x00007f00u) {
    ::memset(&_impl_.match_making_start_time_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&_impl_.mm_preference_) -
        reinterpret_cast<char*>(&_impl_.match_making_start_time_)) + sizeof(_impl_.mm_preference_));
  }
  _impl_._has_bits_.Clear();
  _internal_metadata_.Clear<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}
    ...
    switch (tag >> 3) {
      ...
      case 17:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 138)) {
          ptr = ctx->ParseMessage(_internal_mutable_private_lobby_settings(), ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 18:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 144)) {
          _Internal::set_has_desires_laning_together(&has_bits);
          _impl_.desires_laning_together_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* CSOCitadelParty::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00001000u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteBoolToArray(16, this->_internal_is_private_lobby(), target);
  }

  // optional .CSOCitadelParty.PrivateLobbySettings private_lobby_settings = 17;
  if (cached_has_bits & 0x00000004u) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(17, _Internal::private_lobby_settings(this),
        _Internal::private_lobby_settings(this).GetCachedSize(), target, stream);
  }

  // optional bool desires_laning_together = 18;
  if (cached_has_bits & 0x00002000u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteBoolToArray(18, this->_internal_desires_laning_together(), target);
  }
  ...
  if (cached_has_bits & 0x00004000u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteEnumToArray(
      19, this->_internal_mm_preference(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:CSOCitadelParty)
  ...
  if (cached_has_bits & 0x000000ffu) {
    ...
    if (cached_has_bits & 0x00000004u) {
      total_size += 2 +
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::MessageSize(
          *_impl_.private_lobby_settings_);
    }
...
void CSOCitadelParty::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (cached_has_bits & 0x000000ffu) {
    ...
    if (cached_has_bits & 0x00000004u) {
      _this->_internal_mutable_private_lobby_settings()->::CSOCitadelParty_PrivateLobbySettings::MergeFrom(
          from._internal_private_lobby_settings());
    }
    if (cached_has_bits & 0x00000008u) {
  ...
  if (cached_has_bits & 0x00007f00u) {
    ...
    if (cached_has_bits & 0x00002000u) {
      _this->_impl_.desires_laning_together_ = from._impl_.desires_laning_together_;
    }
    if (cached_has_bits & 0x00004000u) {
      _this->_impl_.mm_preference_ = from._impl_.mm_preference_;
    }
...
void CSOCitadelParty::InternalSwap(CSOCitadelParty* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(CSOCitadelParty, _impl_.mm_preference_)
      + sizeof(CSOCitadelParty::_impl_.mm_preference_)
      - PROTOBUF_FIELD_OFFSET(CSOCitadelParty, _impl_.private_lobby_settings_)>(
          reinterpret_cast<char*>(&_impl_.private_lobby_settings_),
          reinterpret_cast<char*>(&other->_impl_.private_lobby_settings_));
}
...
class CMsgMatchMetaDataContents_MatchInfo::_Internal {
 public:
  ...
  static void set_has_average_badge_team0(HasBits* has_bits) {
    (*has_bits)[0] |= 32768u;
  }
  static void set_has_average_badge_team1(HasBits* has_bits) {
    (*has_bits)[0] |= 65536u;
  }
};
...
CMsgMatchMetaDataContents_MatchInfo::CMsgMatchMetaDataContents_MatchInfo(const CMsgMatchMetaDataContents_MatchInfo& from)
  ...
  new (&_impl_) Impl_{
    ...
    , decltype(_impl_.average_badge_team0_){}
    , decltype(_impl_.average_badge_team1_){}};
  ...
  ::memcpy(&_impl_.duration_s_, &from._impl_.duration_s_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.average_badge_team1_) -
    reinterpret_cast<char*>(&_impl_.duration_s_)) + sizeof(_impl_.average_badge_team1_));
...
// @@protoc_insertion_point(message_clear_start:CMsgMatchMetaDataContents.MatchInfo)
  ...
  if (cached_has_bits & 0x0000ff00u) {
    ::memset(&_impl_.game_mode_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&_impl_.average_badge_team0_) -
        reinterpret_cast<char*>(&_impl_.game_mode_)) + sizeof(_impl_.average_badge_team0_));
  }
...
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  ...
  while (!ctx->Done(&ptr)) {
    ...
    switch (tag >> 3) {
      ...
      case 23:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 184)) {
          _Internal::set_has_average_badge_team0(&has_bits);
          _impl_.average_badge_team0_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 24:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 192)) {
          _Internal::set_has_average_badge_team1(&has_bits);
          _impl_.average_badge_team1_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* CMsgMatchMetaDataContents_MatchInfo::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00001000u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteBoolToArray(20, this->_internal_is_high_skill_range_parties(), target);
  }

  // optional bool low_pri_pool = 21;
  if (cached_has_bits & 0x00002000u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteBoolToArray(21, this->_internal_low_pri_pool(), target);
  }

  // optional bool new_player_pool = 22;
  if (cached_has_bits & 0x00004000u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteBoolToArray(22, this->_internal_new_player_pool(), target);
  }

  // optional uint32 average_badge_team0 = 23;
  if (cached_has_bits & 0x00008000u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt32ToArray(23, this->_internal_average_badge_team0(), target);
  }

  // optional uint32 average_badge_team1 = 24;
  if (cached_has_bits & 0x00010000u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt32ToArray(24, this->_internal_average_badge_team1(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:CMsgMatchMetaDataContents.MatchInfo)
  ...
  if (cached_has_bits & 0x0000ff00u) {
    ...
    if (cached_has_bits & 0x00008000u) {
      total_size += 2 +
        ::_pbi::WireFormatLite::UInt32Size(
          this->_internal_average_badge_team0());
    }
  ...
  if (cached_has_bits & 0x00010000u) {
    total_size += 2 +
      ::_pbi::WireFormatLite::UInt32Size(
        this->_internal_average_badge_team1());
  }
...
void CMsgMatchMetaDataContents_MatchInfo::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (cached_has_bits & 0x0000ff00u) {
    ...
    if (cached_has_bits & 0x00008000u) {
      _this->_impl_.average_badge_team0_ = from._impl_.average_badge_team0_;
    }
    _this->_impl_._has_bits_[0] |= cached_has_bits;
  }
  if (cached_has_bits & 0x00010000u) {
    _this->_internal_set_average_badge_team1(from._internal_average_badge_team1());
  }
  _this->_internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}
...
void CMsgMatchMetaDataContents_MatchInfo::InternalSwap(CMsgMatchMetaDataContents_MatchInfo* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(CMsgMatchMetaDataContents_MatchInfo, _impl_.average_badge_team1_)
      + sizeof(CMsgMatchMetaDataContents_MatchInfo::_impl_.average_badge_team1_)
      - PROTOBUF_FIELD_OFFSET(CMsgMatchMetaDataContents_MatchInfo, _impl_.match_paths_)>(
...
::PROTOBUF_NAMESPACE_ID::Metadata CMsgAccountHeroStats::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_citadel_5fgcmessages_5fcommon_2eproto_getter, &descriptor_table_citadel_5fgcmessages_5fcommon_2eproto_once,
      file_level_metadata_citadel_5fgcmessages_5fcommon_2eproto[43]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata CMsgAccountBookStats::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_citadel_5fgcmessages_5fcommon_2eproto_getter, &descriptor_table_citadel_5fgcmessages_5fcommon_2eproto_once,
      file_level_metadata_citadel_5fgcmessages_5fcommon_2eproto[44]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata CMsgAccountStats::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_citadel_5fgcmessages_5fcommon_2eproto_getter, &descriptor_table_citadel_5fgcmessages_5fcommon_2eproto_once,
      file_level_metadata_citadel_5fgcmessages_5fcommon_2eproto[45]);
}

// ===================================================================

class CMsgGCAccountData::_Internal {
 public:
  using HasBits = decltype(std::declval<CMsgGCAccountData>()._impl_._has_bits_);
  static void set_has_account_id(HasBits* has_bits) {
    (*has_bits)[0] |= 1u;
  }
  static void set_has_cheater_report_score(HasBits* has_bits) {
    (*has_bits)[0] |= 2u;
  }
};

CMsgGCAccountData::CMsgGCAccountData(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:CMsgGCAccountData)
}
CMsgGCAccountData::CMsgGCAccountData(const CMsgGCAccountData& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  CMsgGCAccountData* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){from._impl_._has_bits_}
    , /*decltype(_impl_._cached_size_)*/{}
    , decltype(_impl_.account_id_){}
    , decltype(_impl_.cheater_report_score_){}};

  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::memcpy(&_impl_.account_id_, &from._impl_.account_id_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.cheater_report_score_) -
    reinterpret_cast<char*>(&_impl_.account_id_)) + sizeof(_impl_.cheater_report_score_));
  // @@protoc_insertion_point(copy_constructor:CMsgGCAccountData)
}

inline void CMsgGCAccountData::SharedCtor(
    ::_pb::Arena* arena, bool is_message_owned) {
  (void)arena;
  (void)is_message_owned;
  new (&_impl_) Impl_{
...
CMsgGCAccountData::~CMsgGCAccountData() {
  // @@protoc_insertion_point(destructor:CMsgGCAccountData)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
inline void CMsgGCAccountData::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
}

void CMsgGCAccountData::SetCachedSize(int size) const {
  _impl_._cached_size_.Set(size);
}

void CMsgGCAccountData::Clear() {
// @@protoc_insertion_point(message_clear_start:CMsgGCAccountData)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
  ...
  if (cached_has_bits & 0x00000003u) {
    ::memset(&_impl_.account_id_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&_impl_.cheater_report_score_) -
        reinterpret_cast<char*>(&_impl_.account_id_)) + sizeof(_impl_.cheater_report_score_));
  }
  _impl_._has_bits_.Clear();
  _internal_metadata_.Clear<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
...
const char* CMsgGCAccountData::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  _Internal::HasBits has_bits{};
  while (!ctx->Done(&ptr)) {
    uint32_t tag;
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 21)) {
          _Internal::set_has_cheater_report_score(&has_bits);
          _impl_.cheater_report_score_ = ::PROTOBUF_NAMESPACE_ID::internal::UnalignedLoad<float>(ptr);
          ptr += sizeof(float);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* CMsgGCAccountData::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:CMsgGCAccountData)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (cached_has_bits & 0x00000002u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteFloatToArray(2, this->_internal_cheater_report_score(), target);
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:CMsgGCAccountData)
  return target;
}

size_t CMsgGCAccountData::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:CMsgGCAccountData)
  size_t total_size = 0;
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData CMsgGCAccountData::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSourceCheck,
    CMsgGCAccountData::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*CMsgGCAccountData::GetClassData() const { return &_class_data_; }


void CMsgGCAccountData::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<CMsgGCAccountData*>(&to_msg);
  auto& from = static_cast<const CMsgGCAccountData&>(from_msg);
  // @@protoc_insertion_point(class_specific_merge_from_start:CMsgGCAccountData)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (cached_has_bits & 0x00000003u) {
    ...
    if (cached_has_bits & 0x00000002u) {
      _this->_impl_.cheater_report_score_ = from._impl_.cheater_report_score_;
    }
    _this->_impl_._has_bits_[0] |= cached_has_bits;
  }
  _this->_internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
...
void CMsgGCAccountData::CopyFrom(const CMsgGCAccountData& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:CMsgGCAccountData)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool CMsgGCAccountData::IsInitialized() const {
  return true;
}

void CMsgGCAccountData::InternalSwap(CMsgGCAccountData* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  swap(_impl_._has_bits_[0], other->_impl_._has_bits_[0]);
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(CMsgGCAccountData, _impl_.cheater_report_score_)
      + sizeof(CMsgGCAccountData::_impl_.cheater_report_score_)
      - PROTOBUF_FIELD_OFFSET(CMsgGCAccountData, _impl_.account_id_)>(
          reinterpret_cast<char*>(&_impl_.account_id_),
          reinterpret_cast<char*>(&other->_impl_.account_id_));
}

::PROTOBUF_NAMESPACE_ID::Metadata CMsgGCAccountData::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_citadel_5fgcmessages_5fcommon_2eproto_getter, &descriptor_table_citadel_5fgcmessages_5fcommon_2eproto_once,
      file_level_metadata_citadel_5fgcmessages_5fcommon_2eproto[46]);
}
...
template<> PROTOBUF_NOINLINE ::CSOCitadelParty_PrivateLobbySlot*
Arena::CreateMaybeMessage< ::CSOCitadelParty_PrivateLobbySlot >(Arena* arena) {
  return Arena::CreateMessageInternal< ::CSOCitadelParty_PrivateLobbySlot >(arena);
}
template<> PROTOBUF_NOINLINE ::CSOCitadelParty_ServerRegion*
Arena::CreateMaybeMessage< ::CSOCitadelParty_ServerRegion >(Arena* arena) {
  return Arena::CreateMessageInternal< ::CSOCitadelParty_ServerRegion >(arena);
}
template<> PROTOBUF_NOINLINE ::CSOCitadelParty_PrivateLobbySettings*
Arena::CreateMaybeMessage< ::CSOCitadelParty_PrivateLobbySettings >(Arena* arena) {
  return Arena::CreateMessageInternal< ::CSOCitadelParty_PrivateLobbySettings >(arena);
}
...
template<> PROTOBUF_NOINLINE ::CMsgGCAccountData*
Arena::CreateMaybeMessage< ::CMsgGCAccountData >(Arena* arena) {
  return Arena::CreateMessageInternal< ::CMsgGCAccountData >(arena);
}
