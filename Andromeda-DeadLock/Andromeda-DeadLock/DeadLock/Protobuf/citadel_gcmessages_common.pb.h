...
class CMsgGCAccountData;
struct CMsgGCAccountDataDefaultTypeInternal;
extern CMsgGCAccountDataDefaultTypeInternal _CMsgGCAccountData_default_instance_;
...
class CSOCitadelParty_PrivateLobbySettings;
struct CSOCitadelParty_PrivateLobbySettingsDefaultTypeInternal;
extern CSOCitadelParty_PrivateLobbySettingsDefaultTypeInternal _CSOCitadelParty_PrivateLobbySettings_default_instance_;
class CSOCitadelParty_PrivateLobbySlot;
struct CSOCitadelParty_PrivateLobbySlotDefaultTypeInternal;
extern CSOCitadelParty_PrivateLobbySlotDefaultTypeInternal _CSOCitadelParty_PrivateLobbySlot_default_instance_;
class CSOCitadelParty_ServerRegion;
struct CSOCitadelParty_ServerRegionDefaultTypeInternal;
extern CSOCitadelParty_ServerRegionDefaultTypeInternal _CSOCitadelParty_ServerRegion_default_instance_;
PROTOBUF_NAMESPACE_OPEN
...
template<> ::CMsgGCAccountData* Arena::CreateMaybeMessage<::CMsgGCAccountData>(Arena*);
...
template<> ::CSOCitadelParty_PrivateLobbySettings* Arena::CreateMaybeMessage<::CSOCitadelParty_PrivateLobbySettings>(Arena*);
template<> ::CSOCitadelParty_PrivateLobbySlot* Arena::CreateMaybeMessage<::CSOCitadelParty_PrivateLobbySlot>(Arena*);
template<> ::CSOCitadelParty_ServerRegion* Arena::CreateMaybeMessage<::CSOCitadelParty_ServerRegion>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
enum CMsgMatchMetaDataContents_EGoldSource : int {
  ...
  CMsgMatchMetaDataContents_EGoldSource_k_eTeamBonus = 8
};
...
constexpr CMsgMatchMetaDataContents_EGoldSource CMsgMatchMetaDataContents_EGoldSource_EGoldSource_MAX = CMsgMatchMetaDataContents_EGoldSource_k_eTeamBonus;
...
constexpr ECitadelMatchMode ECitadelMatchMode_MAX = k_ECitadelMatchMode_HeroLabs;
...
enum ECitadelMMPreference : int {
  k_ECitadelMMPreference_Invalid = 0,
  k_ECitadelMMPreference_Casual = 1,
  k_ECitadelMMPreference_Serious = 2
};
bool ECitadelMMPreference_IsValid(int value);
constexpr ECitadelMMPreference ECitadelMMPreference_MIN = k_ECitadelMMPreference_Invalid;
constexpr ECitadelMMPreference ECitadelMMPreference_MAX = k_ECitadelMMPreference_Serious;
constexpr int ECitadelMMPreference_ARRAYSIZE = ECitadelMMPreference_MAX + 1;

const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* ECitadelMMPreference_descriptor();
template<typename T>
inline const std::string& ECitadelMMPreference_Name(T enum_t_value) {
  static_assert(::std::is_same<T, ECitadelMMPreference>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function ECitadelMMPreference_Name.");
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    ECitadelMMPreference_descriptor(), enum_t_value);
}
inline bool ECitadelMMPreference_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, ECitadelMMPreference* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<ECitadelMMPreference>(
    ECitadelMMPreference_descriptor(), name, value);
}
...
enum ECitadelLeaderboardRegion : int {
...
bool ECitadelLeaderboardRegion_IsValid(int value);
constexpr ECitadelLeaderboardRegion ECitadelLeaderboardRegion_MIN = k_ECitadelLeaderboardRegion_None;
constexpr ECitadelLeaderboardRegion ECitadelLeaderboardRegion_MAX = k_ECitadelLeaderboardRegion_Oceania;
constexpr int ECitadelLeaderboardRegion_ARRAYSIZE = ECitadelLeaderboardRegion_MAX + 1;

const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* ECitadelLeaderboardRegion_descriptor();
template<typename T>
inline const std::string& ECitadelLeaderboardRegion_Name(T enum_t_value) {
  static_assert(::std::is_same<T, ECitadelLeaderboardRegion>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function ECitadelLeaderboardRegion_Name.");
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    ECitadelLeaderboardRegion_descriptor(), enum_t_value);
}
inline bool ECitadelLeaderboardRegion_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, ECitadelLeaderboardRegion* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<ECitadelLeaderboardRegion>(
    ECitadelLeaderboardRegion_descriptor(), name, value);
}
...
bool EBannedFeature_IsValid(int value);
constexpr EBannedFeature EBannedFeature_MIN = k_eBannedFeature_Invalid;
constexpr EBannedFeature EBannedFeature_MAX = k_eBannedFeature_ReportingDisabled;
constexpr int EBannedFeature_ARRAYSIZE = EBannedFeature_MAX + 1;

const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* EBannedFeature_descriptor();
template<typename T>
inline const std::string& EBannedFeature_Name(T enum_t_value) {
  static_assert(::std::is_same<T, EBannedFeature>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function EBannedFeature_Name.");
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    EBannedFeature_descriptor(), enum_t_value);
}
inline bool EBannedFeature_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, EBannedFeature* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<EBannedFeature>(
    EBannedFeature_descriptor(), name, value);
}
enum EFeatureBanReason : int {
...
bool EFeatureBanReason_IsValid(int value);
constexpr EFeatureBanReason EFeatureBanReason_MIN = k_eFeatureBanReason_Invalid;
constexpr EFeatureBanReason EFeatureBanReason_MAX = k_eFeatureBanReason_ExcessivePlayerReports;
constexpr int EFeatureBanReason_ARRAYSIZE = EFeatureBanReason_MAX + 1;

const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* EFeatureBanReason_descriptor();
template<typename T>
inline const std::string& EFeatureBanReason_Name(T enum_t_value) {
  static_assert(::std::is_same<T, EFeatureBanReason>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function EFeatureBanReason_Name.");
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    EFeatureBanReason_descriptor(), enum_t_value);
}
inline bool EFeatureBanReason_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, EFeatureBanReason* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<EFeatureBanReason>(
    EFeatureBanReason_descriptor(), name, value);
}
// ===================================================================
...
class CSOCitadelLobby final :
 ...
 public:
  ...
  enum : int {
    ...
    kMatchPunishesAbandonsFieldNumber = 15,
  };
  ...
  bool has_match_punishes_abandons() const;
  private:
  bool _internal_has_match_punishes_abandons() const;
  public:
  void clear_match_punishes_abandons();
  bool match_punishes_abandons() const;
  void set_match_punishes_abandons(bool value);
  private:
  bool _internal_match_punishes_abandons() const;
  void _internal_set_match_punishes_abandons(bool value);
  public:
...
class CMsgStartFindingMatchInfo final :
 ...
 public:
  ...
  enum : int {
    ...
    kPreferSoloOnlyFieldNumber = 9,
    kMmPreferenceFieldNumber = 10,
  };
  ...
  bool has_prefer_solo_only() const;
  private:
  bool _internal_has_prefer_solo_only() const;
  public:
  void clear_prefer_solo_only();
  bool prefer_solo_only() const;
  void set_prefer_solo_only(bool value);
  private:
  bool _internal_prefer_solo_only() const;
  void _internal_set_prefer_solo_only(bool value);
  public:
...
class CSOCitadelParty_PrivateLobbySlot final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:CSOCitadelParty.PrivateLobbySlot) */ {
 public:
  inline CSOCitadelParty_PrivateLobbySlot() : CSOCitadelParty_PrivateLobbySlot(nullptr) {}
  ~CSOCitadelParty_PrivateLobbySlot() override;
  explicit PROTOBUF_CONSTEXPR CSOCitadelParty_PrivateLobbySlot(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  CSOCitadelParty_PrivateLobbySlot(const CSOCitadelParty_PrivateLobbySlot& from);
  CSOCitadelParty_PrivateLobbySlot(CSOCitadelParty_PrivateLobbySlot&& from) noexcept
    : CSOCitadelParty_PrivateLobbySlot() {
    *this = ::std::move(from);
  }

  inline CSOCitadelParty_PrivateLobbySlot& operator=(const CSOCitadelParty_PrivateLobbySlot& from) {
    CopyFrom(from);
    return *this;
  }
  inline CSOCitadelParty_PrivateLobbySlot& operator=(CSOCitadelParty_PrivateLobbySlot&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const CSOCitadelParty_PrivateLobbySlot& default_instance() {
    return *internal_default_instance();
  }
  static inline const CSOCitadelParty_PrivateLobbySlot* internal_default_instance() {
    return reinterpret_cast<const CSOCitadelParty_PrivateLobbySlot*>(
               &_CSOCitadelParty_PrivateLobbySlot_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    10;

  friend void swap(CSOCitadelParty_PrivateLobbySlot& a, CSOCitadelParty_PrivateLobbySlot& b) {
    a.Swap(&b);
  }
  inline void Swap(CSOCitadelParty_PrivateLobbySlot* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(CSOCitadelParty_PrivateLobbySlot* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  CSOCitadelParty_PrivateLobbySlot* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<CSOCitadelParty_PrivateLobbySlot>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const CSOCitadelParty_PrivateLobbySlot& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const CSOCitadelParty_PrivateLobbySlot& from) {
    CSOCitadelParty_PrivateLobbySlot::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(CSOCitadelParty_PrivateLobbySlot* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "CSOCitadelParty.PrivateLobbySlot";
  }
  protected:
  explicit CSOCitadelParty_PrivateLobbySlot(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  // @@protoc_insertion_point(class_scope:CSOCitadelParty.PrivateLobbySlot)
 private:
  class _Internal;
...
class CSOCitadelParty_ServerRegion final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:CSOCitadelParty.ServerRegion) */ {
 public:
  inline CSOCitadelParty_ServerRegion() : CSOCitadelParty_ServerRegion(nullptr) {}
  ~CSOCitadelParty_ServerRegion() override;
  explicit PROTOBUF_CONSTEXPR CSOCitadelParty_ServerRegion(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  CSOCitadelParty_ServerRegion(const CSOCitadelParty_ServerRegion& from);
  CSOCitadelParty_ServerRegion(CSOCitadelParty_ServerRegion&& from) noexcept
    : CSOCitadelParty_ServerRegion() {
    *this = ::std::move(from);
  }

  inline CSOCitadelParty_ServerRegion& operator=(const CSOCitadelParty_ServerRegion& from) {
    CopyFrom(from);
    return *this;
  }
  inline CSOCitadelParty_ServerRegion& operator=(CSOCitadelParty_ServerRegion&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const CSOCitadelParty_ServerRegion& default_instance() {
    return *internal_default_instance();
  }
  static inline const CSOCitadelParty_ServerRegion* internal_default_instance() {
    return reinterpret_cast<const CSOCitadelParty_ServerRegion*>(
               &_CSOCitadelParty_ServerRegion_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    11;

  friend void swap(CSOCitadelParty_ServerRegion& a, CSOCitadelParty_ServerRegion& b) {
    a.Swap(&b);
  }
  inline void Swap(CSOCitadelParty_ServerRegion* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(CSOCitadelParty_ServerRegion* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  CSOCitadelParty_ServerRegion* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<CSOCitadelParty_ServerRegion>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const CSOCitadelParty_ServerRegion& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const CSOCitadelParty_ServerRegion& from) {
    CSOCitadelParty_ServerRegion::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(CSOCitadelParty_ServerRegion* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "CSOCitadelParty.ServerRegion";
  }
  protected:
  explicit CSOCitadelParty_ServerRegion(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  // @@protoc_insertion_point(class_scope:CSOCitadelParty.ServerRegion)
 private:
  class _Internal;
...
class CSOCitadelParty_PrivateLobbySettings final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:CSOCitadelParty.PrivateLobbySettings) */ {
 public:
  inline CSOCitadelParty_PrivateLobbySettings() : CSOCitadelParty_PrivateLobbySettings(nullptr) {}
  ~CSOCitadelParty_PrivateLobbySettings() override;
  explicit PROTOBUF_CONSTEXPR CSOCitadelParty_PrivateLobbySettings(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  CSOCitadelParty_PrivateLobbySettings(const CSOCitadelParty_PrivateLobbySettings& from);
  CSOCitadelParty_PrivateLobbySettings(CSOCitadelParty_PrivateLobbySettings&& from) noexcept
    : CSOCitadelParty_PrivateLobbySettings() {
    *this = ::std::move(from);
  }

  inline CSOCitadelParty_PrivateLobbySettings& operator=(const CSOCitadelParty_PrivateLobbySettings& from) {
    CopyFrom(from);
    return *this;
  }
  inline CSOCitadelParty_PrivateLobbySettings& operator=(CSOCitadelParty_PrivateLobbySettings&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const CSOCitadelParty_PrivateLobbySettings& default_instance() {
    return *internal_default_instance();
  }
  static inline const CSOCitadelParty_PrivateLobbySettings* internal_default_instance() {
    return reinterpret_cast<const CSOCitadelParty_PrivateLobbySettings*>(
               &_CSOCitadelParty_PrivateLobbySettings_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    12;

  friend void swap(CSOCitadelParty_PrivateLobbySettings& a, CSOCitadelParty_PrivateLobbySettings& b) {
    a.Swap(&b);
  }
  inline void Swap(CSOCitadelParty_PrivateLobbySettings* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(CSOCitadelParty_PrivateLobbySettings* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  CSOCitadelParty_PrivateLobbySettings* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<CSOCitadelParty_PrivateLobbySettings>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const CSOCitadelParty_PrivateLobbySettings& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const CSOCitadelParty_PrivateLobbySettings& from) {
    CSOCitadelParty_PrivateLobbySettings::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(CSOCitadelParty_PrivateLobbySettings* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "CSOCitadelParty.PrivateLobbySettings";
  }
  protected:
  explicit CSOCitadelParty_PrivateLobbySettings(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  enum : int {
    kMatchSlotsFieldNumber = 2,
    kAvailableRegionsFieldNumber = 8,
    kMinRosterSizeFieldNumber = 1,
    kServerRegionFieldNumber = 4,
    kRandomizeLanesFieldNumber = 3,
    kIsPubliclyVisibleFieldNumber = 6,
    kCheatsEnabledFieldNumber = 7,
    kDuplicateHeroesEnabledFieldNumber = 9,
    kExperimentalHeroesEnabledFieldNumber = 10,
  };
  // repeated .CSOCitadelParty.PrivateLobbySlot match_slots = 2;
  int match_slots_size() const;
  private:
  int _internal_match_slots_size() const;
  public:
  void clear_match_slots();
  ::CSOCitadelParty_PrivateLobbySlot* mutable_match_slots(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CSOCitadelParty_PrivateLobbySlot >*
      mutable_match_slots();
  private:
  const ::CSOCitadelParty_PrivateLobbySlot& _internal_match_slots(int index) const;
  ::CSOCitadelParty_PrivateLobbySlot* _internal_add_match_slots();
  public:
  const ::CSOCitadelParty_PrivateLobbySlot& match_slots(int index) const;
  ::CSOCitadelParty_PrivateLobbySlot* add_match_slots();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CSOCitadelParty_PrivateLobbySlot >&
      match_slots() const;

  // repeated .CSOCitadelParty.ServerRegion available_regions = 8;
  int available_regions_size() const;
  private:
  int _internal_available_regions_size() const;
  public:
  void clear_available_regions();
  ::CSOCitadelParty_ServerRegion* mutable_available_regions(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CSOCitadelParty_ServerRegion >*
      mutable_available_regions();
  private:
  const ::CSOCitadelParty_ServerRegion& _internal_available_regions(int index) const;
  ::CSOCitadelParty_ServerRegion* _internal_add_available_regions();
  public:
  const ::CSOCitadelParty_ServerRegion& available_regions(int index) const;
  ::CSOCitadelParty_ServerRegion* add_available_regions();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CSOCitadelParty_ServerRegion >&
      available_regions() const;

  // optional uint32 min_roster_size = 1;
  bool has_min_roster_size() const;
  private:
  bool _internal_has_min_roster_size() const;
  public:
  void clear_min_roster_size();
  uint32_t min_roster_size() const;
  void set_min_roster_size(uint32_t value);
  private:
  uint32_t _internal_min_roster_size() const;
  void _internal_set_min_roster_size(uint32_t value);
  public:
  ...
  bool has_randomize_lanes() const;
  private:
  bool _internal_has_randomize_lanes() const;
  public:
  void clear_randomize_lanes();
  bool randomize_lanes() const;
  void set_randomize_lanes(bool value);
  private:
  bool _internal_randomize_lanes() const;
  void _internal_set_randomize_lanes(bool value);
  public:

  // optional bool is_publicly_visible = 6;
  bool has_is_publicly_visible() const;
  private:
  bool _internal_has_is_publicly_visible() const;
  public:
  void clear_is_publicly_visible();
  bool is_publicly_visible() const;
  void set_is_publicly_visible(bool value);
  private:
  bool _internal_is_publicly_visible() const;
  void _internal_set_is_publicly_visible(bool value);
  public:

  // optional bool cheats_enabled = 7;
  bool has_cheats_enabled() const;
  private:
  bool _internal_has_cheats_enabled() const;
  public:
  void clear_cheats_enabled();
  bool cheats_enabled() const;
  void set_cheats_enabled(bool value);
  private:
  bool _internal_cheats_enabled() const;
  void _internal_set_cheats_enabled(bool value);
  public:

  // optional bool duplicate_heroes_enabled = 9;
  bool has_duplicate_heroes_enabled() const;
  private:
  bool _internal_has_duplicate_heroes_enabled() const;
  public:
  void clear_duplicate_heroes_enabled();
  bool duplicate_heroes_enabled() const;
  void set_duplicate_heroes_enabled(bool value);
  private:
  bool _internal_duplicate_heroes_enabled() const;
  void _internal_set_duplicate_heroes_enabled(bool value);
  public:
  ...
  // @@protoc_insertion_point(class_scope:CSOCitadelParty.PrivateLobbySettings)
 private:
  class _Internal;
  ...
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::internal::HasBits<1> _has_bits_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CSOCitadelParty_PrivateLobbySlot > match_slots_;
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CSOCitadelParty_ServerRegion > available_regions_;
    uint32_t min_roster_size_;
    uint32_t server_region_;
    bool randomize_lanes_;
    bool is_publicly_visible_;
...
class CSOCitadelParty final :
 ...
 public:
  ...
  typedef CSOCitadelParty_PrivateLobbySlot PrivateLobbySlot;
  typedef CSOCitadelParty_ServerRegion ServerRegion;
  typedef CSOCitadelParty_PrivateLobbySettings PrivateLobbySettings;
  ...
  enum : int {
    ...
    kPrivateLobbySettingsFieldNumber = 17,
    ...
    kIsPrivateLobbyFieldNumber = 16,
    kDesiresLaningTogetherFieldNumber = 18,
    kMmPreferenceFieldNumber = 19,
  };
  ...
  bool has_private_lobby_settings() const;
  private:
  bool _internal_has_private_lobby_settings() const;
  public:
  void clear_private_lobby_settings();
  const ::CSOCitadelParty_PrivateLobbySettings& private_lobby_settings() const;
  PROTOBUF_NODISCARD ::CSOCitadelParty_PrivateLobbySettings* release_private_lobby_settings();
  ::CSOCitadelParty_PrivateLobbySettings* mutable_private_lobby_settings();
  void set_allocated_private_lobby_settings(::CSOCitadelParty_PrivateLobbySettings* private_lobby_settings);
  private:
  const ::CSOCitadelParty_PrivateLobbySettings& _internal_private_lobby_settings() const;
  ::CSOCitadelParty_PrivateLobbySettings* _internal_mutable_private_lobby_settings();
  public:
  void unsafe_arena_set_allocated_private_lobby_settings(
      ::CSOCitadelParty_PrivateLobbySettings* private_lobby_settings);
  ::CSOCitadelParty_PrivateLobbySettings* unsafe_arena_release_private_lobby_settings();
  ...
  bool has_desires_laning_together() const;
  private:
  bool _internal_has_desires_laning_together() const;
  public:
  void clear_desires_laning_together();
  bool desires_laning_together() const;
  void set_desires_laning_together(bool value);
  private:
  bool _internal_desires_laning_together() const;
  void _internal_set_desires_laning_together(bool value);
  public:
 ...
 private:
  ...
  struct Impl_ {
    ...
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr server_search_key_;
    ::CSOCitadelParty_PrivateLobbySettings* private_lobby_settings_;
    uint64_t party_id_;
    uint64_t join_code_;
    int bot_difficulty_;
    int match_mode_;
...
class CMsgMatchMetaDataContents_MatchInfo final :
 ...
 public:
  ...
  enum : int {
    ...
    kIsHighSkillRangePartiesFieldNumber = 20,
    kLowPriPoolFieldNumber = 21,
    kNewPlayerPoolFieldNumber = 22,
    kAverageBadgeTeam0FieldNumber = 23,
    kAverageBadgeTeam1FieldNumber = 24,
  };
  ...
  bool has_is_high_skill_range_parties() const;
  private:
  bool _internal_has_is_high_skill_range_parties() const;
  public:
  void clear_is_high_skill_range_parties();
  bool is_high_skill_range_parties() const;
  void set_is_high_skill_range_parties(bool value);
  private:
  bool _internal_is_high_skill_range_parties() const;
  void _internal_set_is_high_skill_range_parties(bool value);
  public:

  // optional bool low_pri_pool = 21;
  bool has_low_pri_pool() const;
  private:
  bool _internal_has_low_pri_pool() const;
  public:
  void clear_low_pri_pool();
  bool low_pri_pool() const;
  void set_low_pri_pool(bool value);
  private:
  bool _internal_low_pri_pool() const;
  void _internal_set_low_pri_pool(bool value);
  public:

  // optional bool new_player_pool = 22;
  bool has_new_player_pool() const;
  private:
  bool _internal_has_new_player_pool() const;
  public:
  void clear_new_player_pool();
  bool new_player_pool() const;
  void set_new_player_pool(bool value);
  private:
  bool _internal_new_player_pool() const;
  void _internal_set_new_player_pool(bool value);
  public:

  // optional uint32 average_badge_team0 = 23;
  bool has_average_badge_team0() const;
  private:
  bool _internal_has_average_badge_team0() const;
  public:
  void clear_average_badge_team0();
  uint32_t average_badge_team0() const;
  void set_average_badge_team0(uint32_t value);
  private:
  uint32_t _internal_average_badge_team0() const;
  void _internal_set_average_badge_team0(uint32_t value);
  public:

  // optional uint32 average_badge_team1 = 24;
  bool has_average_badge_team1() const;
  private:
  bool _internal_has_average_badge_team1() const;
  public:
  void clear_average_badge_team1();
  uint32_t average_badge_team1() const;
  void set_average_badge_team1(uint32_t value);
  private:
  uint32_t _internal_average_badge_team1() const;
  void _internal_set_average_badge_team1(uint32_t value);
  public:
 ...
 private:
  ...
  struct Impl_ {
    ...
    uint32_t average_badge_team0_;
    uint32_t average_badge_team1_;
  };
  union { Impl_ _impl_; };
  friend struct ::TableStruct_citadel_5fgcmessages_5fcommon_2eproto;
};
...
class CMsgMatchMetaDataContents final :
 ...
 public:
  ...
  static constexpr EGoldSource k_eTeamBonus =
    CMsgMatchMetaDataContents_EGoldSource_k_eTeamBonus;
...
class CMsgGCAccountData final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:CMsgGCAccountData) */ {
 public:
  inline CMsgGCAccountData() : CMsgGCAccountData(nullptr) {}
  ~CMsgGCAccountData() override;
  explicit PROTOBUF_CONSTEXPR CMsgGCAccountData(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  CMsgGCAccountData(const CMsgGCAccountData& from);
  CMsgGCAccountData(CMsgGCAccountData&& from) noexcept
    : CMsgGCAccountData() {
    *this = ::std::move(from);
  }

  inline CMsgGCAccountData& operator=(const CMsgGCAccountData& from) {
    CopyFrom(from);
    return *this;
  }
  inline CMsgGCAccountData& operator=(CMsgGCAccountData&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const CMsgGCAccountData& default_instance() {
    return *internal_default_instance();
  }
  static inline const CMsgGCAccountData* internal_default_instance() {
    return reinterpret_cast<const CMsgGCAccountData*>(
               &_CMsgGCAccountData_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    46;

  friend void swap(CMsgGCAccountData& a, CMsgGCAccountData& b) {
    a.Swap(&b);
  }
  inline void Swap(CMsgGCAccountData* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(CMsgGCAccountData* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  CMsgGCAccountData* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<CMsgGCAccountData>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const CMsgGCAccountData& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const CMsgGCAccountData& from) {
    CMsgGCAccountData::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(CMsgGCAccountData* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "CMsgGCAccountData";
  }
  protected:
  explicit CMsgGCAccountData(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  enum : int {
    kAccountIdFieldNumber = 1,
    kCheaterReportScoreFieldNumber = 2,
  };
  // optional uint32 account_id = 1;
  bool has_account_id() const;
  private:
  ...
  bool has_cheater_report_score() const;
  private:
  bool _internal_has_cheater_report_score() const;
  public:
  void clear_cheater_report_score();
  float cheater_report_score() const;
  void set_cheater_report_score(float value);
  private:
  float _internal_cheater_report_score() const;
  void _internal_set_cheater_report_score(float value);
  public:

  // @@protoc_insertion_point(class_scope:CMsgGCAccountData)
 private:
  class _Internal;
...
// optional bool match_punishes_abandons = 15;
inline bool CSOCitadelLobby::_internal_has_match_punishes_abandons() const {
  bool value = (_impl_._has_bits_[0] & 0x00001000u) != 0;
  return value;
}
inline bool CSOCitadelLobby::has_match_punishes_abandons() const {
  return _internal_has_match_punishes_abandons();
}
inline void CSOCitadelLobby::clear_match_punishes_abandons() {
  _impl_.match_punishes_abandons_ = false;
  _impl_._has_bits_[0] &= ~0x00001000u;
}
inline bool CSOCitadelLobby::_internal_match_punishes_abandons() const {
  return _impl_.match_punishes_abandons_;
}
inline bool CSOCitadelLobby::match_punishes_abandons() const {
  // @@protoc_insertion_point(field_get:CSOCitadelLobby.match_punishes_abandons)
  return _internal_match_punishes_abandons();
}
inline void CSOCitadelLobby::_internal_set_match_punishes_abandons(bool value) {
  _impl_._has_bits_[0] |= 0x00001000u;
  _impl_.match_punishes_abandons_ = value;
}
inline void CSOCitadelLobby::set_match_punishes_abandons(bool value) {
  _internal_set_match_punishes_abandons(value);
  // @@protoc_insertion_point(field_set:CSOCitadelLobby.match_punishes_abandons)
}
...
// optional bool prefer_solo_only = 9;
inline bool CMsgStartFindingMatchInfo::_internal_has_prefer_solo_only() const {
  bool value = (_impl_._has_bits_[0] & 0x00000040u) != 0;
  return value;
}
inline bool CMsgStartFindingMatchInfo::has_prefer_solo_only() const {
  return _internal_has_prefer_solo_only();
}
inline void CMsgStartFindingMatchInfo::clear_prefer_solo_only() {
  _impl_.prefer_solo_only_ = false;
  _impl_._has_bits_[0] &= ~0x00000040u;
}
inline bool CMsgStartFindingMatchInfo::_internal_prefer_solo_only() const {
  return _impl_.prefer_solo_only_;
}
inline bool CMsgStartFindingMatchInfo::prefer_solo_only() const {
  // @@protoc_insertion_point(field_get:CMsgStartFindingMatchInfo.prefer_solo_only)
  return _internal_prefer_solo_only();
}
inline void CMsgStartFindingMatchInfo::_internal_set_prefer_solo_only(bool value) {
  _impl_._has_bits_[0] |= 0x00000040u;
  _impl_.prefer_solo_only_ = value;
}
inline void CMsgStartFindingMatchInfo::set_prefer_solo_only(bool value) {
  _internal_set_prefer_solo_only(value);
  // @@protoc_insertion_point(field_set:CMsgStartFindingMatchInfo.prefer_solo_only)
}

// optional .ECitadelMMPreference mm_preference = 10 [default = k_ECitadelMMPreference_Invalid];
inline bool CMsgStartFindingMatchInfo::_internal_has_mm_preference() const {
  bool value = (_impl_._has_bits_[0] & 0x00000080u) != 0;
  return value;
}
inline bool CMsgStartFindingMatchInfo::has_mm_preference() const {
  return _internal_has_mm_preference();
}
inline void CMsgStartFindingMatchInfo::clear_mm_preference() {
  _impl_.mm_preference_ = 0;
  _impl_._has_bits_[0] &= ~0x00000080u;
}
inline ::ECitadelMMPreference CMsgStartFindingMatchInfo::_internal_mm_preference() const {
  return static_cast< ::ECitadelMMPreference >(_impl_.mm_preference_);
}
inline ::ECitadelMMPreference CMsgStartFindingMatchInfo::mm_preference() const {
  // @@protoc_insertion_point(field_get:CMsgStartFindingMatchInfo.mm_preference)
  return _internal_mm_preference();
}
inline void CMsgStartFindingMatchInfo::_internal_set_mm_preference(::ECitadelMMPreference value) {
  assert(::ECitadelMMPreference_IsValid(value));
  _impl_._has_bits_[0] |= 0x00000080u;
  _impl_.mm_preference_ = value;
}
inline void CMsgStartFindingMatchInfo::set_mm_preference(::ECitadelMMPreference value) {
  _internal_set_mm_preference(value);
  // @@protoc_insertion_point(field_set:CMsgStartFindingMatchInfo.mm_preference)
}
...
// optional uint32 slot_id = 1;
inline bool CSOCitadelParty_PrivateLobbySlot::_internal_has_slot_id() const {
  bool value = (_impl_._has_bits_[0] & 0x00000001u) != 0;
  return value;
}
inline bool CSOCitadelParty_PrivateLobbySlot::has_slot_id() const {
  return _internal_has_slot_id();
}
inline void CSOCitadelParty_PrivateLobbySlot::clear_slot_id() {
  _impl_.slot_id_ = 0u;
  _impl_._has_bits_[0] &= ~0x00000001u;
}
inline uint32_t CSOCitadelParty_PrivateLobbySlot::_internal_slot_id() const {
  return _impl_.slot_id_;
}
inline uint32_t CSOCitadelParty_PrivateLobbySlot::slot_id() const {
  // @@protoc_insertion_point(field_get:CSOCitadelParty.PrivateLobbySlot.slot_id)
  return _internal_slot_id();
}
inline void CSOCitadelParty_PrivateLobbySlot::_internal_set_slot_id(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000001u;
  _impl_.slot_id_ = value;
}
inline void CSOCitadelParty_PrivateLobbySlot::set_slot_id(uint32_t value) {
  _internal_set_slot_id(value);
  // @@protoc_insertion_point(field_set:CSOCitadelParty.PrivateLobbySlot.slot_id)
}

// optional uint32 player_account_id = 2;
inline bool CSOCitadelParty_PrivateLobbySlot::_internal_has_player_account_id() const {
  bool value = (_impl_._has_bits_[0] & 0x00000002u) != 0;
  return value;
}
inline bool CSOCitadelParty_PrivateLobbySlot::has_player_account_id() const {
  return _internal_has_player_account_id();
}
inline void CSOCitadelParty_PrivateLobbySlot::clear_player_account_id() {
  _impl_.player_account_id_ = 0u;
  _impl_._has_bits_[0] &= ~0x00000002u;
}
inline uint32_t CSOCitadelParty_PrivateLobbySlot::_internal_player_account_id() const {
  return _impl_.player_account_id_;
}
inline uint32_t CSOCitadelParty_PrivateLobbySlot::player_account_id() const {
  // @@protoc_insertion_point(field_get:CSOCitadelParty.PrivateLobbySlot.player_account_id)
  return _internal_player_account_id();
}
inline void CSOCitadelParty_PrivateLobbySlot::_internal_set_player_account_id(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000002u;
  _impl_.player_account_id_ = value;
}
inline void CSOCitadelParty_PrivateLobbySlot::set_player_account_id(uint32_t value) {
  _internal_set_player_account_id(value);
  // @@protoc_insertion_point(field_set:CSOCitadelParty.PrivateLobbySlot.player_account_id)
}
...
// optional uint32 region_id = 1;
inline bool CSOCitadelParty_ServerRegion::_internal_has_region_id() const {
  bool value = (_impl_._has_bits_[0] & 0x00000001u) != 0;
  return value;
}
inline bool CSOCitadelParty_ServerRegion::has_region_id() const {
  return _internal_has_region_id();
}
inline void CSOCitadelParty_ServerRegion::clear_region_id() {
  _impl_.region_id_ = 0u;
  _impl_._has_bits_[0] &= ~0x00000001u;
}
inline uint32_t CSOCitadelParty_ServerRegion::_internal_region_id() const {
  return _impl_.region_id_;
}
inline uint32_t CSOCitadelParty_ServerRegion::region_id() const {
  // @@protoc_insertion_point(field_get:CSOCitadelParty.ServerRegion.region_id)
  return _internal_region_id();
}
inline void CSOCitadelParty_ServerRegion::_internal_set_region_id(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000001u;
  _impl_.region_id_ = value;
}
inline void CSOCitadelParty_ServerRegion::set_region_id(uint32_t value) {
  _internal_set_region_id(value);
  // @@protoc_insertion_point(field_set:CSOCitadelParty.ServerRegion.region_id)
}
...
// optional uint32 min_roster_size = 1;
inline bool CSOCitadelParty_PrivateLobbySettings::_internal_has_min_roster_size() const {
  bool value = (_impl_._has_bits_[0] & 0x00000001u) != 0;
  return value;
}
inline bool CSOCitadelParty_PrivateLobbySettings::has_min_roster_size() const {
  return _internal_has_min_roster_size();
}
inline void CSOCitadelParty_PrivateLobbySettings::clear_min_roster_size() {
  _impl_.min_roster_size_ = 0u;
  _impl_._has_bits_[0] &= ~0x00000001u;
}
inline uint32_t CSOCitadelParty_PrivateLobbySettings::_internal_min_roster_size() const {
  return _impl_.min_roster_size_;
}
inline uint32_t CSOCitadelParty_PrivateLobbySettings::min_roster_size() const {
  // @@protoc_insertion_point(field_get:CSOCitadelParty.PrivateLobbySettings.min_roster_size)
  return _internal_min_roster_size();
}
inline void CSOCitadelParty_PrivateLobbySettings::_internal_set_min_roster_size(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000001u;
  _impl_.min_roster_size_ = value;
}
inline void CSOCitadelParty_PrivateLobbySettings::set_min_roster_size(uint32_t value) {
  _internal_set_min_roster_size(value);
  // @@protoc_insertion_point(field_set:CSOCitadelParty.PrivateLobbySettings.min_roster_size)
}

// repeated .CSOCitadelParty.PrivateLobbySlot match_slots = 2;
inline int CSOCitadelParty_PrivateLobbySettings::_internal_match_slots_size() const {
  return _impl_.match_slots_.size();
}
inline int CSOCitadelParty_PrivateLobbySettings::match_slots_size() const {
  return _internal_match_slots_size();
}
inline void CSOCitadelParty_PrivateLobbySettings::clear_match_slots() {
  _impl_.match_slots_.Clear();
}
inline ::CSOCitadelParty_PrivateLobbySlot* CSOCitadelParty_PrivateLobbySettings::mutable_match_slots(int index) {
  // @@protoc_insertion_point(field_mutable:CSOCitadelParty.PrivateLobbySettings.match_slots)
  return _impl_.match_slots_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CSOCitadelParty_PrivateLobbySlot >*
CSOCitadelParty_PrivateLobbySettings::mutable_match_slots() {
  // @@protoc_insertion_point(field_mutable_list:CSOCitadelParty.PrivateLobbySettings.match_slots)
  return &_impl_.match_slots_;
}
inline const ::CSOCitadelParty_PrivateLobbySlot& CSOCitadelParty_PrivateLobbySettings::_internal_match_slots(int index) const {
  return _impl_.match_slots_.Get(index);
}
inline const ::CSOCitadelParty_PrivateLobbySlot& CSOCitadelParty_PrivateLobbySettings::match_slots(int index) const {
  // @@protoc_insertion_point(field_get:CSOCitadelParty.PrivateLobbySettings.match_slots)
  return _internal_match_slots(index);
}
inline ::CSOCitadelParty_PrivateLobbySlot* CSOCitadelParty_PrivateLobbySettings::_internal_add_match_slots() {
  return _impl_.match_slots_.Add();
}
inline ::CSOCitadelParty_PrivateLobbySlot* CSOCitadelParty_PrivateLobbySettings::add_match_slots() {
  ::CSOCitadelParty_PrivateLobbySlot* _add = _internal_add_match_slots();
  // @@protoc_insertion_point(field_add:CSOCitadelParty.PrivateLobbySettings.match_slots)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CSOCitadelParty_PrivateLobbySlot >&
CSOCitadelParty_PrivateLobbySettings::match_slots() const {
  // @@protoc_insertion_point(field_list:CSOCitadelParty.PrivateLobbySettings.match_slots)
  return _impl_.match_slots_;
}

// optional bool randomize_lanes = 3;
inline bool CSOCitadelParty_PrivateLobbySettings::_internal_has_randomize_lanes() const {
  bool value = (_impl_._has_bits_[0] & 0x00000004u) != 0;
  return value;
}
inline bool CSOCitadelParty_PrivateLobbySettings::has_randomize_lanes() const {
  return _internal_has_randomize_lanes();
}
inline void CSOCitadelParty_PrivateLobbySettings::clear_randomize_lanes() {
  _impl_.randomize_lanes_ = false;
  _impl_._has_bits_[0] &= ~0x00000004u;
}
inline bool CSOCitadelParty_PrivateLobbySettings::_internal_randomize_lanes() const {
  return _impl_.randomize_lanes_;
}
inline bool CSOCitadelParty_PrivateLobbySettings::randomize_lanes() const {
  // @@protoc_insertion_point(field_get:CSOCitadelParty.PrivateLobbySettings.randomize_lanes)
  return _internal_randomize_lanes();
}
inline void CSOCitadelParty_PrivateLobbySettings::_internal_set_randomize_lanes(bool value) {
  _impl_._has_bits_[0] |= 0x00000004u;
  _impl_.randomize_lanes_ = value;
}
inline void CSOCitadelParty_PrivateLobbySettings::set_randomize_lanes(bool value) {
  _internal_set_randomize_lanes(value);
  // @@protoc_insertion_point(field_set:CSOCitadelParty.PrivateLobbySettings.randomize_lanes)
}

// optional uint32 server_region = 4;
inline bool CSOCitadelParty_PrivateLobbySettings::_internal_has_server_region() const {
  bool value = (_impl_._has_bits_[0] & 0x00000002u) != 0;
  return value;
}
inline bool CSOCitadelParty_PrivateLobbySettings::has_server_region() const {
  return _internal_has_server_region();
}
inline void CSOCitadelParty_PrivateLobbySettings::clear_server_region() {
  _impl_.server_region_ = 0u;
  _impl_._has_bits_[0] &= ~0x00000002u;
}
inline uint32_t CSOCitadelParty_PrivateLobbySettings::_internal_server_region() const {
  return _impl_.server_region_;
}
inline uint32_t CSOCitadelParty_PrivateLobbySettings::server_region() const {
  // @@protoc_insertion_point(field_get:CSOCitadelParty.PrivateLobbySettings.server_region)
  return _internal_server_region();
}
inline void CSOCitadelParty_PrivateLobbySettings::_internal_set_server_region(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000002u;
  _impl_.server_region_ = value;
}
inline void CSOCitadelParty_PrivateLobbySettings::set_server_region(uint32_t value) {
  _internal_set_server_region(value);
  // @@protoc_insertion_point(field_set:CSOCitadelParty.PrivateLobbySettings.server_region)
}

// optional bool is_publicly_visible = 6;
inline bool CSOCitadelParty_PrivateLobbySettings::_internal_has_is_publicly_visible() const {
  bool value = (_impl_._has_bits_[0] & 0x00000008u) != 0;
  return value;
}
inline bool CSOCitadelParty_PrivateLobbySettings::has_is_publicly_visible() const {
  return _internal_has_is_publicly_visible();
}
inline void CSOCitadelParty_PrivateLobbySettings::clear_is_publicly_visible() {
  _impl_.is_publicly_visible_ = false;
  _impl_._has_bits_[0] &= ~0x00000008u;
}
inline bool CSOCitadelParty_PrivateLobbySettings::_internal_is_publicly_visible() const {
  return _impl_.is_publicly_visible_;
}
inline bool CSOCitadelParty_PrivateLobbySettings::is_publicly_visible() const {
  // @@protoc_insertion_point(field_get:CSOCitadelParty.PrivateLobbySettings.is_publicly_visible)
  return _internal_is_publicly_visible();
}
inline void CSOCitadelParty_PrivateLobbySettings::_internal_set_is_publicly_visible(bool value) {
  _impl_._has_bits_[0] |= 0x00000008u;
  _impl_.is_publicly_visible_ = value;
}
inline void CSOCitadelParty_PrivateLobbySettings::set_is_publicly_visible(bool value) {
  _internal_set_is_publicly_visible(value);
  // @@protoc_insertion_point(field_set:CSOCitadelParty.PrivateLobbySettings.is_publicly_visible)
}

// optional bool cheats_enabled = 7;
inline bool CSOCitadelParty_PrivateLobbySettings::_internal_has_cheats_enabled() const {
  bool value = (_impl_._has_bits_[0] & 0x00000010u) != 0;
  return value;
}
inline bool CSOCitadelParty_PrivateLobbySettings::has_cheats_enabled() const {
  return _internal_has_cheats_enabled();
}
inline void CSOCitadelParty_PrivateLobbySettings::clear_cheats_enabled() {
  _impl_.cheats_enabled_ = false;
  _impl_._has_bits_[0] &= ~0x00000010u;
}
inline bool CSOCitadelParty_PrivateLobbySettings::_internal_cheats_enabled() const {
  return _impl_.cheats_enabled_;
}
inline bool CSOCitadelParty_PrivateLobbySettings::cheats_enabled() const {
  // @@protoc_insertion_point(field_get:CSOCitadelParty.PrivateLobbySettings.cheats_enabled)
  return _internal_cheats_enabled();
}
inline void CSOCitadelParty_PrivateLobbySettings::_internal_set_cheats_enabled(bool value) {
  _impl_._has_bits_[0] |= 0x00000010u;
  _impl_.cheats_enabled_ = value;
}
inline void CSOCitadelParty_PrivateLobbySettings::set_cheats_enabled(bool value) {
  _internal_set_cheats_enabled(value);
  // @@protoc_insertion_point(field_set:CSOCitadelParty.PrivateLobbySettings.cheats_enabled)
}

// repeated .CSOCitadelParty.ServerRegion available_regions = 8;
inline int CSOCitadelParty_PrivateLobbySettings::_internal_available_regions_size() const {
  return _impl_.available_regions_.size();
}
inline int CSOCitadelParty_PrivateLobbySettings::available_regions_size() const {
  return _internal_available_regions_size();
}
inline void CSOCitadelParty_PrivateLobbySettings::clear_available_regions() {
  _impl_.available_regions_.Clear();
}
inline ::CSOCitadelParty_ServerRegion* CSOCitadelParty_PrivateLobbySettings::mutable_available_regions(int index) {
  // @@protoc_insertion_point(field_mutable:CSOCitadelParty.PrivateLobbySettings.available_regions)
  return _impl_.available_regions_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CSOCitadelParty_ServerRegion >*
CSOCitadelParty_PrivateLobbySettings::mutable_available_regions() {
  // @@protoc_insertion_point(field_mutable_list:CSOCitadelParty.PrivateLobbySettings.available_regions)
  return &_impl_.available_regions_;
}
inline const ::CSOCitadelParty_ServerRegion& CSOCitadelParty_PrivateLobbySettings::_internal_available_regions(int index) const {
  return _impl_.available_regions_.Get(index);
}
inline const ::CSOCitadelParty_ServerRegion& CSOCitadelParty_PrivateLobbySettings::available_regions(int index) const {
  // @@protoc_insertion_point(field_get:CSOCitadelParty.PrivateLobbySettings.available_regions)
  return _internal_available_regions(index);
}
inline ::CSOCitadelParty_ServerRegion* CSOCitadelParty_PrivateLobbySettings::_internal_add_available_regions() {
  return _impl_.available_regions_.Add();
}
inline ::CSOCitadelParty_ServerRegion* CSOCitadelParty_PrivateLobbySettings::add_available_regions() {
  ::CSOCitadelParty_ServerRegion* _add = _internal_add_available_regions();
  // @@protoc_insertion_point(field_add:CSOCitadelParty.PrivateLobbySettings.available_regions)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CSOCitadelParty_ServerRegion >&
CSOCitadelParty_PrivateLobbySettings::available_regions() const {
  // @@protoc_insertion_point(field_list:CSOCitadelParty.PrivateLobbySettings.available_regions)
  return _impl_.available_regions_;
}

// optional bool duplicate_heroes_enabled = 9;
inline bool CSOCitadelParty_PrivateLobbySettings::_internal_has_duplicate_heroes_enabled() const {
  bool value = (_impl_._has_bits_[0] & 0x00000020u) != 0;
  return value;
}
inline bool CSOCitadelParty_PrivateLobbySettings::has_duplicate_heroes_enabled() const {
  return _internal_has_duplicate_heroes_enabled();
}
inline void CSOCitadelParty_PrivateLobbySettings::clear_duplicate_heroes_enabled() {
  _impl_.duplicate_heroes_enabled_ = false;
  _impl_._has_bits_[0] &= ~0x00000020u;
}
inline bool CSOCitadelParty_PrivateLobbySettings::_internal_duplicate_heroes_enabled() const {
  return _impl_.duplicate_heroes_enabled_;
}
inline bool CSOCitadelParty_PrivateLobbySettings::duplicate_heroes_enabled() const {
  // @@protoc_insertion_point(field_get:CSOCitadelParty.PrivateLobbySettings.duplicate_heroes_enabled)
  return _internal_duplicate_heroes_enabled();
}
inline void CSOCitadelParty_PrivateLobbySettings::_internal_set_duplicate_heroes_enabled(bool value) {
  _impl_._has_bits_[0] |= 0x00000020u;
  _impl_.duplicate_heroes_enabled_ = value;
}
inline void CSOCitadelParty_PrivateLobbySettings::set_duplicate_heroes_enabled(bool value) {
  _internal_set_duplicate_heroes_enabled(value);
  // @@protoc_insertion_point(field_set:CSOCitadelParty.PrivateLobbySettings.duplicate_heroes_enabled)
}

// optional bool experimental_heroes_enabled = 10;
inline bool CSOCitadelParty_PrivateLobbySettings::_internal_has_experimental_heroes_enabled() const {
  bool value = (_impl_._has_bits_[0] & 0x00000040u) != 0;
  return value;
}
inline bool CSOCitadelParty_PrivateLobbySettings::has_experimental_heroes_enabled() const {
  return _internal_has_experimental_heroes_enabled();
}
inline void CSOCitadelParty_PrivateLobbySettings::clear_experimental_heroes_enabled() {
  _impl_.experimental_heroes_enabled_ = false;
  _impl_._has_bits_[0] &= ~0x00000040u;
}
inline bool CSOCitadelParty_PrivateLobbySettings::_internal_experimental_heroes_enabled() const {
  return _impl_.experimental_heroes_enabled_;
}
inline bool CSOCitadelParty_PrivateLobbySettings::experimental_heroes_enabled() const {
  // @@protoc_insertion_point(field_get:CSOCitadelParty.PrivateLobbySettings.experimental_heroes_enabled)
  return _internal_experimental_heroes_enabled();
}
inline void CSOCitadelParty_PrivateLobbySettings::_internal_set_experimental_heroes_enabled(bool value) {
  _impl_._has_bits_[0] |= 0x00000040u;
  _impl_.experimental_heroes_enabled_ = value;
}
inline void CSOCitadelParty_PrivateLobbySettings::set_experimental_heroes_enabled(bool value) {
  _internal_set_experimental_heroes_enabled(value);
  // @@protoc_insertion_point(field_set:CSOCitadelParty.PrivateLobbySettings.experimental_heroes_enabled)
}
...
// optional bool is_private_lobby = 16;
inline bool CSOCitadelParty::_internal_has_is_private_lobby() const {
  bool value = (_impl_._has_bits_[0] & 0x00001000u) != 0;
  return value;
}
inline bool CSOCitadelParty::has_is_private_lobby() const {
  return _internal_has_is_private_lobby();
}
inline void CSOCitadelParty::clear_is_private_lobby() {
  _impl_.is_private_lobby_ = false;
  _impl_._has_bits_[0] &= ~0x00001000u;
}
inline bool CSOCitadelParty::_internal_is_private_lobby() const {
  return _impl_.is_private_lobby_;
}
inline bool CSOCitadelParty::is_private_lobby() const {
  // @@protoc_insertion_point(field_get:CSOCitadelParty.is_private_lobby)
  return _internal_is_private_lobby();
}
inline void CSOCitadelParty::_internal_set_is_private_lobby(bool value) {
  _impl_._has_bits_[0] |= 0x00001000u;
  _impl_.is_private_lobby_ = value;
}
inline void CSOCitadelParty::set_is_private_lobby(bool value) {
  _internal_set_is_private_lobby(value);
  // @@protoc_insertion_point(field_set:CSOCitadelParty.is_private_lobby)
}

// optional .CSOCitadelParty.PrivateLobbySettings private_lobby_settings = 17;
inline bool CSOCitadelParty::_internal_has_private_lobby_settings() const {
  bool value = (_impl_._has_bits_[0] & 0x00000004u) != 0;
  PROTOBUF_ASSUME(!value || _impl_.private_lobby_settings_ != nullptr);
  return value;
}
inline bool CSOCitadelParty::has_private_lobby_settings() const {
  return _internal_has_private_lobby_settings();
}
inline void CSOCitadelParty::clear_private_lobby_settings() {
  if (_impl_.private_lobby_settings_ != nullptr) _impl_.private_lobby_settings_->Clear();
  _impl_._has_bits_[0] &= ~0x00000004u;
}
inline const ::CSOCitadelParty_PrivateLobbySettings& CSOCitadelParty::_internal_private_lobby_settings() const {
  const ::CSOCitadelParty_PrivateLobbySettings* p = _impl_.private_lobby_settings_;
  return p != nullptr ? *p : reinterpret_cast<const ::CSOCitadelParty_PrivateLobbySettings&>(
      ::_CSOCitadelParty_PrivateLobbySettings_default_instance_);
}
inline const ::CSOCitadelParty_PrivateLobbySettings& CSOCitadelParty::private_lobby_settings() const {
  // @@protoc_insertion_point(field_get:CSOCitadelParty.private_lobby_settings)
  return _internal_private_lobby_settings();
}
inline void CSOCitadelParty::unsafe_arena_set_allocated_private_lobby_settings(
    ::CSOCitadelParty_PrivateLobbySettings* private_lobby_settings) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.private_lobby_settings_);
  }
  _impl_.private_lobby_settings_ = private_lobby_settings;
  if (private_lobby_settings) {
    _impl_._has_bits_[0] |= 0x00000004u;
  } else {
    _impl_._has_bits_[0] &= ~0x00000004u;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:CSOCitadelParty.private_lobby_settings)
}
inline ::CSOCitadelParty_PrivateLobbySettings* CSOCitadelParty::release_private_lobby_settings() {
  _impl_._has_bits_[0] &= ~0x00000004u;
  ::CSOCitadelParty_PrivateLobbySettings* temp = _impl_.private_lobby_settings_;
  _impl_.private_lobby_settings_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  if (GetArenaForAllocation() == nullptr) { delete old; }
...
inline ::CSOCitadelParty_PrivateLobbySettings* CSOCitadelParty::unsafe_arena_release_private_lobby_settings() {
  // @@protoc_insertion_point(field_release:CSOCitadelParty.private_lobby_settings)
  _impl_._has_bits_[0] &= ~0x00000004u;
  ::CSOCitadelParty_PrivateLobbySettings* temp = _impl_.private_lobby_settings_;
  _impl_.private_lobby_settings_ = nullptr;
  return temp;
}
inline ::CSOCitadelParty_PrivateLobbySettings* CSOCitadelParty::_internal_mutable_private_lobby_settings() {
  _impl_._has_bits_[0] |= 0x00000004u;
  if (_impl_.private_lobby_settings_ == nullptr) {
    auto* p = CreateMaybeMessage<::CSOCitadelParty_PrivateLobbySettings>(GetArenaForAllocation());
    _impl_.private_lobby_settings_ = p;
  }
  return _impl_.private_lobby_settings_;
}
inline ::CSOCitadelParty_PrivateLobbySettings* CSOCitadelParty::mutable_private_lobby_settings() {
  ::CSOCitadelParty_PrivateLobbySettings* _msg = _internal_mutable_private_lobby_settings();
  // @@protoc_insertion_point(field_mutable:CSOCitadelParty.private_lobby_settings)
  return _msg;
}
inline void CSOCitadelParty::set_allocated_private_lobby_settings(::CSOCitadelParty_PrivateLobbySettings* private_lobby_settings) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.private_lobby_settings_;
  }
  if (private_lobby_settings) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(private_lobby_settings);
    if (message_arena != submessage_arena) {
      private_lobby_settings = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
          message_arena, private_lobby_settings, submessage_arena);
    }
    _impl_._has_bits_[0] |= 0x00000004u;
  } else {
    _impl_._has_bits_[0] &= ~0x00000004u;
  ...
  _impl_.private_lobby_settings_ = private_lobby_settings;
  // @@protoc_insertion_point(field_set_allocated:CSOCitadelParty.private_lobby_settings)
}

// optional bool desires_laning_together = 18;
inline bool CSOCitadelParty::_internal_has_desires_laning_together() const {
  bool value = (_impl_._has_bits_[0] & 0x00002000u) != 0;
  return value;
}
inline bool CSOCitadelParty::has_desires_laning_together() const {
  return _internal_has_desires_laning_together();
}
inline void CSOCitadelParty::clear_desires_laning_together() {
  _impl_.desires_laning_together_ = false;
  _impl_._has_bits_[0] &= ~0x00002000u;
}
inline bool CSOCitadelParty::_internal_desires_laning_together() const {
  return _impl_.desires_laning_together_;
}
inline bool CSOCitadelParty::desires_laning_together() const {
  // @@protoc_insertion_point(field_get:CSOCitadelParty.desires_laning_together)
  return _internal_desires_laning_together();
}
inline void CSOCitadelParty::_internal_set_desires_laning_together(bool value) {
  _impl_._has_bits_[0] |= 0x00002000u;
  _impl_.desires_laning_together_ = value;
}
inline void CSOCitadelParty::set_desires_laning_together(bool value) {
  _internal_set_desires_laning_together(value);
  // @@protoc_insertion_point(field_set:CSOCitadelParty.desires_laning_together)
}

// optional .ECitadelMMPreference mm_preference = 19 [default = k_ECitadelMMPreference_Invalid];
inline bool CSOCitadelParty::_internal_has_mm_preference() const {
  bool value = (_impl_._has_bits_[0] & 0x00004000u) != 0;
  return value;
}
inline bool CSOCitadelParty::has_mm_preference() const {
  return _internal_has_mm_preference();
}
inline void CSOCitadelParty::clear_mm_preference() {
  _impl_.mm_preference_ = 0;
  _impl_._has_bits_[0] &= ~0x00004000u;
}
inline ::ECitadelMMPreference CSOCitadelParty::_internal_mm_preference() const {
  return static_cast< ::ECitadelMMPreference >(_impl_.mm_preference_);
}
inline ::ECitadelMMPreference CSOCitadelParty::mm_preference() const {
  // @@protoc_insertion_point(field_get:CSOCitadelParty.mm_preference)
  return _internal_mm_preference();
}
inline void CSOCitadelParty::_internal_set_mm_preference(::ECitadelMMPreference value) {
  assert(::ECitadelMMPreference_IsValid(value));
  _impl_._has_bits_[0] |= 0x00004000u;
  _impl_.mm_preference_ = value;
}
inline void CSOCitadelParty::set_mm_preference(::ECitadelMMPreference value) {
  _internal_set_mm_preference(value);
  // @@protoc_insertion_point(field_set:CSOCitadelParty.mm_preference)
}
...
// optional bool is_high_skill_range_parties = 20;
inline bool CMsgMatchMetaDataContents_MatchInfo::_internal_has_is_high_skill_range_parties() const {
  bool value = (_impl_._has_bits_[0] & 0x00001000u) != 0;
  return value;
}
inline bool CMsgMatchMetaDataContents_MatchInfo::has_is_high_skill_range_parties() const {
  return _internal_has_is_high_skill_range_parties();
}
inline void CMsgMatchMetaDataContents_MatchInfo::clear_is_high_skill_range_parties() {
  _impl_.is_high_skill_range_parties_ = false;
  _impl_._has_bits_[0] &= ~0x00001000u;
}
inline bool CMsgMatchMetaDataContents_MatchInfo::_internal_is_high_skill_range_parties() const {
  return _impl_.is_high_skill_range_parties_;
}
inline bool CMsgMatchMetaDataContents_MatchInfo::is_high_skill_range_parties() const {
  // @@protoc_insertion_point(field_get:CMsgMatchMetaDataContents.MatchInfo.is_high_skill_range_parties)
  return _internal_is_high_skill_range_parties();
}
inline void CMsgMatchMetaDataContents_MatchInfo::_internal_set_is_high_skill_range_parties(bool value) {
  _impl_._has_bits_[0] |= 0x00001000u;
  _impl_.is_high_skill_range_parties_ = value;
}
inline void CMsgMatchMetaDataContents_MatchInfo::set_is_high_skill_range_parties(bool value) {
  _internal_set_is_high_skill_range_parties(value);
  // @@protoc_insertion_point(field_set:CMsgMatchMetaDataContents.MatchInfo.is_high_skill_range_parties)
}

// optional bool low_pri_pool = 21;
inline bool CMsgMatchMetaDataContents_MatchInfo::_internal_has_low_pri_pool() const {
  bool value = (_impl_._has_bits_[0] & 0x00002000u) != 0;
  return value;
}
inline bool CMsgMatchMetaDataContents_MatchInfo::has_low_pri_pool() const {
  return _internal_has_low_pri_pool();
}
inline void CMsgMatchMetaDataContents_MatchInfo::clear_low_pri_pool() {
  _impl_.low_pri_pool_ = false;
  _impl_._has_bits_[0] &= ~0x00002000u;
}
inline bool CMsgMatchMetaDataContents_MatchInfo::_internal_low_pri_pool() const {
  return _impl_.low_pri_pool_;
}
inline bool CMsgMatchMetaDataContents_MatchInfo::low_pri_pool() const {
  // @@protoc_insertion_point(field_get:CMsgMatchMetaDataContents.MatchInfo.low_pri_pool)
  return _internal_low_pri_pool();
}
inline void CMsgMatchMetaDataContents_MatchInfo::_internal_set_low_pri_pool(bool value) {
  _impl_._has_bits_[0] |= 0x00002000u;
  _impl_.low_pri_pool_ = value;
}
inline void CMsgMatchMetaDataContents_MatchInfo::set_low_pri_pool(bool value) {
  _internal_set_low_pri_pool(value);
  // @@protoc_insertion_point(field_set:CMsgMatchMetaDataContents.MatchInfo.low_pri_pool)
}

// optional bool new_player_pool = 22;
inline bool CMsgMatchMetaDataContents_MatchInfo::_internal_has_new_player_pool() const {
  bool value = (_impl_._has_bits_[0] & 0x00004000u) != 0;
  return value;
}
inline bool CMsgMatchMetaDataContents_MatchInfo::has_new_player_pool() const {
  return _internal_has_new_player_pool();
}
inline void CMsgMatchMetaDataContents_MatchInfo::clear_new_player_pool() {
  _impl_.new_player_pool_ = false;
  _impl_._has_bits_[0] &= ~0x00004000u;
}
inline bool CMsgMatchMetaDataContents_MatchInfo::_internal_new_player_pool() const {
  return _impl_.new_player_pool_;
}
inline bool CMsgMatchMetaDataContents_MatchInfo::new_player_pool() const {
  // @@protoc_insertion_point(field_get:CMsgMatchMetaDataContents.MatchInfo.new_player_pool)
  return _internal_new_player_pool();
}
inline void CMsgMatchMetaDataContents_MatchInfo::_internal_set_new_player_pool(bool value) {
  _impl_._has_bits_[0] |= 0x00004000u;
  _impl_.new_player_pool_ = value;
}
inline void CMsgMatchMetaDataContents_MatchInfo::set_new_player_pool(bool value) {
  _internal_set_new_player_pool(value);
  // @@protoc_insertion_point(field_set:CMsgMatchMetaDataContents.MatchInfo.new_player_pool)
}

// optional uint32 average_badge_team0 = 23;
inline bool CMsgMatchMetaDataContents_MatchInfo::_internal_has_average_badge_team0() const {
  bool value = (_impl_._has_bits_[0] & 0x00008000u) != 0;
  return value;
}
inline bool CMsgMatchMetaDataContents_MatchInfo::has_average_badge_team0() const {
  return _internal_has_average_badge_team0();
}
inline void CMsgMatchMetaDataContents_MatchInfo::clear_average_badge_team0() {
  _impl_.average_badge_team0_ = 0u;
  _impl_._has_bits_[0] &= ~0x00008000u;
}
inline uint32_t CMsgMatchMetaDataContents_MatchInfo::_internal_average_badge_team0() const {
  return _impl_.average_badge_team0_;
}
inline uint32_t CMsgMatchMetaDataContents_MatchInfo::average_badge_team0() const {
  // @@protoc_insertion_point(field_get:CMsgMatchMetaDataContents.MatchInfo.average_badge_team0)
  return _internal_average_badge_team0();
}
inline void CMsgMatchMetaDataContents_MatchInfo::_internal_set_average_badge_team0(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00008000u;
  _impl_.average_badge_team0_ = value;
}
inline void CMsgMatchMetaDataContents_MatchInfo::set_average_badge_team0(uint32_t value) {
  _internal_set_average_badge_team0(value);
  // @@protoc_insertion_point(field_set:CMsgMatchMetaDataContents.MatchInfo.average_badge_team0)
}

// optional uint32 average_badge_team1 = 24;
inline bool CMsgMatchMetaDataContents_MatchInfo::_internal_has_average_badge_team1() const {
  bool value = (_impl_._has_bits_[0] & 0x00010000u) != 0;
  return value;
}
inline bool CMsgMatchMetaDataContents_MatchInfo::has_average_badge_team1() const {
  return _internal_has_average_badge_team1();
}
inline void CMsgMatchMetaDataContents_MatchInfo::clear_average_badge_team1() {
  _impl_.average_badge_team1_ = 0u;
  _impl_._has_bits_[0] &= ~0x00010000u;
}
inline uint32_t CMsgMatchMetaDataContents_MatchInfo::_internal_average_badge_team1() const {
  return _impl_.average_badge_team1_;
}
inline uint32_t CMsgMatchMetaDataContents_MatchInfo::average_badge_team1() const {
  // @@protoc_insertion_point(field_get:CMsgMatchMetaDataContents.MatchInfo.average_badge_team1)
  return _internal_average_badge_team1();
}
inline void CMsgMatchMetaDataContents_MatchInfo::_internal_set_average_badge_team1(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00010000u;
  _impl_.average_badge_team1_ = value;
}
inline void CMsgMatchMetaDataContents_MatchInfo::set_average_badge_team1(uint32_t value) {
  _internal_set_average_badge_team1(value);
  // @@protoc_insertion_point(field_set:CMsgMatchMetaDataContents.MatchInfo.average_badge_team1)
}
...
// optional uint32 account_id = 1;
inline bool CMsgGCAccountData::_internal_has_account_id() const {
  bool value = (_impl_._has_bits_[0] & 0x00000001u) != 0;
  return value;
}
inline bool CMsgGCAccountData::has_account_id() const {
  return _internal_has_account_id();
}
inline void CMsgGCAccountData::clear_account_id() {
  _impl_.account_id_ = 0u;
  _impl_._has_bits_[0] &= ~0x00000001u;
}
inline uint32_t CMsgGCAccountData::_internal_account_id() const {
  return _impl_.account_id_;
}
inline uint32_t CMsgGCAccountData::account_id() const {
  // @@protoc_insertion_point(field_get:CMsgGCAccountData.account_id)
  return _internal_account_id();
}
inline void CMsgGCAccountData::_internal_set_account_id(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000001u;
  _impl_.account_id_ = value;
}
inline void CMsgGCAccountData::set_account_id(uint32_t value) {
  _internal_set_account_id(value);
  // @@protoc_insertion_point(field_set:CMsgGCAccountData.account_id)
}

// optional float cheater_report_score = 2;
inline bool CMsgGCAccountData::_internal_has_cheater_report_score() const {
  bool value = (_impl_._has_bits_[0] & 0x00000002u) != 0;
  return value;
}
inline bool CMsgGCAccountData::has_cheater_report_score() const {
  return _internal_has_cheater_report_score();
}
inline void CMsgGCAccountData::clear_cheater_report_score() {
  _impl_.cheater_report_score_ = 0;
  _impl_._has_bits_[0] &= ~0x00000002u;
}
inline float CMsgGCAccountData::_internal_cheater_report_score() const {
  return _impl_.cheater_report_score_;
}
inline float CMsgGCAccountData::cheater_report_score() const {
  // @@protoc_insertion_point(field_get:CMsgGCAccountData.cheater_report_score)
  return _internal_cheater_report_score();
}
inline void CMsgGCAccountData::_internal_set_cheater_report_score(float value) {
  _impl_._has_bits_[0] |= 0x00000002u;
  _impl_.cheater_report_score_ = value;
}
inline void CMsgGCAccountData::set_cheater_report_score(float value) {
  _internal_set_cheater_report_score(value);
  // @@protoc_insertion_point(field_set:CMsgGCAccountData.cheater_report_score)
}
...
template <> struct is_proto_enum< ::ECitadelMMPreference> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::ECitadelMMPreference>() {
  return ::ECitadelMMPreference_descriptor();
}
...
template <> struct is_proto_enum< ::ECitadelLeaderboardRegion> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::ECitadelLeaderboardRegion>() {
  return ::ECitadelLeaderboardRegion_descriptor();
}
...
template <> struct is_proto_enum< ::EBannedFeature> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::EBannedFeature>() {
  return ::EBannedFeature_descriptor();
}
template <> struct is_proto_enum< ::EFeatureBanReason> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::EFeatureBanReason>() {
  return ::EFeatureBanReason_descriptor();
}
